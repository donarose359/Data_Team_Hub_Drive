...
/**
 * Job: D_HDO_elds Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20190924_1038-M2
 * @status 
 */
public class D_HDO_elds implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "D_HDO_elds";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(D_HDO_elds.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_TEST_D_HDO_elds = new byte[0];
    static byte[] commonByteArray_TEST_D_HDO_elds = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_D_HDO_elds.length) {
				if(length < 1024 && commonByteArray_TEST_D_HDO_elds.length == 0) {
   					commonByteArray_TEST_D_HDO_elds = new byte[1024];
				} else {
   					commonByteArray_TEST_D_HDO_elds = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_D_HDO_elds, 0, length);
			strReturn = new String(commonByteArray_TEST_D_HDO_elds, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_D_HDO_elds) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_elds/HDO_elds.json")).getAbsolutePath().replace("\\","/");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_D_HDO_elds_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_D_HDO_elds_" + pid +"_tHashOutput_1");
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_eld_index" ,env_tSystem_1);
...
try{
    ...
    int bos_buffer_tHttpRequest_1 = 0;
            java.io.InputStream bisParam_tHttpRequest_1 = new java.io.BufferedInputStream(new java.io.FileInputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_eldsFRH.json"));
...
public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_2 = "D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_elds";
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_2 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_2.add("HDO_elds*.json");  
...
try{
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_2) {
        java.io.InputStream bis_tHttpRequest_2 = new java.io.BufferedInputStream(urlConn_tHttpRequest_2.getInputStream());
                java.io.File bosParent_tHttpRequest_2 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_elds/Error/HDO_tc_elds_Error"+Numeric.sequence("z1",0,1)+".json").getParentFile();
                if (bosParent_tHttpRequest_2 != null && bosParent_tHttpRequest_2.exists() == false){
                    bosParent_tHttpRequest_2.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_2 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_elds/Error/HDO_tc_elds_Error"+Numeric.sequence("z1",0,1)+".json"));
...
final Process ps_tSystem_2 = runtime_tSystem_2.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_eld_index/_doc/1?pretty" ,env_tSystem_2);
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_D_HDO_elds_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_D_HDO_elds_" + pid +"_tHashOutput_2");
...
public void tFileList_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_3 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_3.add("*eld*.xlsx");  
...
public static class copyOfout1Struct implements routines.system.IPersistableRow<copyOfout1Struct> {
    ...
    static byte[] commonByteArray_TEST_D_HDO_elds = new byte[0];
			    ...
			    public String vehicleApi;

				public String getVehicleApi () {
					return this.vehicleApi;
				}
				
			    public String hosApi;

				public String getHosApi () {
					return this.hosApi;
				}
		...
		synchronized(commonByteArrayLock_TEST_D_HDO_elds) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.eld = readString(dis);
					
					this.name = readString(dis);
					
					this.displayName = readString(dis);
					
					this.locationApi = readString(dis);
					
					this.vehicleApi = readString(dis);
					
					this.hosApi = readString(dis);
					
					this.driverApi = readString(dis);
					
					this.imagePath = readString(dis);
					
					this.params = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.locationApi,dos);
					
					// String
				
						writeString(this.vehicleApi,dos);
					
					// String
				
						writeString(this.hosApi,dos);
					
					// String
				
						writeString(this.driverApi,dos);
					
					// String
				
						writeString(this.imagePath,dos);
					
					// String
				
						writeString(this.params,dos);
    ...
    public String toString() {
		...
		sb.append(",locationApi="+locationApi);
		sb.append(",vehicleApi="+vehicleApi);
		sb.append(",hosApi="+hosApi);
		sb.append(",driverApi="+driverApi);
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_D_HDO_elds_" + pid + "_tHashOutput_3";
 ...
 */
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
		    ...
		    row2 = null;
					int tempRowLength_tFileInputExcel_2 = 9;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				curColName_tFileInputExcel_2 = "eld";

				row2.eld = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.eld = null;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row2.name = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.name = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "displayName";

				row2.displayName = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.displayName = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "locationApi";

				row2.locationApi = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.locationApi = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "vehicleApi";

				row2.vehicleApi = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.vehicleApi = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "hosApi";

				row2.hosApi = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.hosApi = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "driverApi";

				row2.driverApi = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.driverApi = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "imagePath";

				row2.imagePath = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.imagePath = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "params";

				row2.params = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.params = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
...
copyOfout1_tmp.eld = row2.eld ;
copyOfout1_tmp.name = row2.name ;
copyOfout1_tmp.displayName = row2.displayName ;
copyOfout1_tmp.locationApi = row2.locationApi ;
copyOfout1_tmp.vehicleApi = row2.vehicleApi ;
copyOfout1_tmp.hosApi = row2.hosApi ;
copyOfout1_tmp.driverApi = row2.driverApi ;
copyOfout1_tmp.imagePath = row2.imagePath ;
copyOfout1_tmp.params = row2.params ;
...
if(copyOfout1 != null) { 
	...
	currentComponent="tHashOutput_3";
		...
		copyOfout1Struct oneRow_tHashOutput_3 = new copyOfout1Struct();
					...
					oneRow_tHashOutput_3.eld = copyOfout1.eld;
					oneRow_tHashOutput_3.name = copyOfout1.name;
					oneRow_tHashOutput_3.displayName = copyOfout1.displayName;
					oneRow_tHashOutput_3.locationApi = copyOfout1.locationApi;
					oneRow_tHashOutput_3.vehicleApi = copyOfout1.vehicleApi;
					oneRow_tHashOutput_3.hosApi = copyOfout1.hosApi;
					oneRow_tHashOutput_3.driverApi = copyOfout1.driverApi;
					oneRow_tHashOutput_3.imagePath = copyOfout1.imagePath;
					oneRow_tHashOutput_3.params = copyOfout1.params;
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
    ...
    static byte[] commonByteArray_TEST_D_HDO_elds = new byte[0];
			    ...
			    public String location_api;

				public String getLocation_api () {
					return this.location_api;
				}
				
			    public String vehicle_api;

				public String getVehicle_api () {
					return this.vehicle_api;
				}
				
			    public String hos_api;

				public String getHos_api () {
					return this.hos_api;
				}
				
			    public String driver_api;

				public String getDriver_api () {
					return this.driver_api;
				}
		...
		synchronized(commonByteArrayLock_TEST_D_HDO_elds) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.location_api = readString(dis);
					
					this.vehicle_api = readString(dis);
					
					this.hos_api = readString(dis);
					
					this.driver_api = readString(dis);
					
					this.image_path = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.location_api,dos);
					
					// String
				
						writeString(this.vehicle_api,dos);
					
					// String
				
						writeString(this.hos_api,dos);
					
					// String
				
						writeString(this.driver_api,dos);
					
					// String
				
						writeString(this.image_path,dos);
    ...
    public String toString() {
		...
		sb.append(",id2="+id2);
		sb.append(",eld="+String.valueOf(eld));
		sb.append(",name="+name);
		sb.append(",display_name="+display_name);
		sb.append(",location_api="+location_api);
		sb.append(",vehicle_api="+vehicle_api);
		sb.append(",hos_api="+hos_api);
		sb.append(",driver_api="+driver_api);
		sb.append(",image_path="+image_path);
		sb.append(",params="+params);
	    sb.append("]");
...
public static class conv1Struct implements routines.system.IPersistableRow<conv1Struct> {
    final static byte[] commonByteArrayLock_TEST_D_HDO_elds = new byte[0];
    static byte[] commonByteArray_TEST_D_HDO_elds = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(conv1Struct other) {
...
conv1Struct conv1 = new conv1Struct();
 ...
 */
	...
	currentComponent="tConvertType_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"conv1");
					}
...
// ###############################
// # Outputs initialization
conv1Struct conv1_tmp = new conv1Struct();
// ###############################
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<copyOfout1Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_D_HDO_elds_" + pid +"_tHashOutput_3");
...
while (iterator_tHashInput_3.hasNext()) {
	...
	row1.eld = next_tHashInput_3.eld;
	row1.name = next_tHashInput_3.name;
	row1.displayName = next_tHashInput_3.displayName;
	row1.locationApi = next_tHashInput_3.locationApi;
	row1.vehicleApi = next_tHashInput_3.vehicleApi;
	row1.hosApi = next_tHashInput_3.hosApi;
	row1.driverApi = next_tHashInput_3.driverApi;
	row1.imagePath = next_tHashInput_3.imagePath;
	row1.params = next_tHashInput_3.params;
...
// # Output table : 'conv1'
conv1_tmp.eld = row1.eld ;
conv1_tmp.name = row1.name ;
conv1_tmp.displayName = row1.displayName ;
conv1_tmp.locationApi = row1.locationApi ;
conv1_tmp.vehicleApi = row1.vehicleApi ;
conv1_tmp.hosApi = row1.hosApi ;
conv1_tmp.driverApi = row1.driverApi ;
conv1_tmp.imagePath = row1.imagePath ;
conv1_tmp.params = row1.params ;
conv1 = conv1_tmp;
// ###############################
...
if(conv1 != null) { 
	...
	currentComponent="tConvertType_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"conv1");
					}
  ...
  boolean bHasError_tConvertType_1 = false;             
          try {
              out1.eld=TypeConvert.String2Double(conv1.eld);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.name=TypeConvert.String2String(conv1.name);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.displayName=TypeConvert.String2String(conv1.displayName);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.locationApi=TypeConvert.String2String(conv1.locationApi);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.vehicleApi=TypeConvert.String2String(conv1.vehicleApi);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.hosApi=TypeConvert.String2String(conv1.hosApi);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.driverApi=TypeConvert.String2String(conv1.driverApi);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.imagePath=TypeConvert.String2String(conv1.imagePath);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.params=TypeConvert.String2String(conv1.params);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }
...
// # Output table : 'out4'
out4_tmp._index = "eos_hdo_tc_prod_eld_index" ;
...
out2_tmp.eld = out1.eld ;
out2_tmp.name = out1.name ;
out2_tmp.display_name = out1.displayName ;
out2_tmp.location_api = out1.locationApi ;
out2_tmp.vehicle_api = out1.vehicleApi ;
out2_tmp.hos_api = out1.hosApi ;
out2_tmp.driver_api = out1.driverApi ;
out2_tmp.image_path = out1.imagePath ;
out2_tmp.params = out1.params ;
out2 = out2_tmp;
// ###############################
...
if(out2 != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("eld",
	(
		out2.eld != null?
            out2.eld.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("eld",
	(
		out2.eld != null?
            out2.eld.toString():null
		));
	...
	(
		out2.name != null?
            out2.name.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("name",
	(
		out2.name != null?
            out2.name.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("display_name",
	(
		out2.display_name != null?
            out2.display_name.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("display_name",
	(
		out2.display_name != null?
            out2.display_name.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("location_api",
	(
		out2.location_api != null?
            out2.location_api.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("location_api",
	(
		out2.location_api != null?
            out2.location_api.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("vehicle_api",
	(
		out2.vehicle_api != null?
            out2.vehicle_api.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("vehicle_api",
	(
		out2.vehicle_api != null?
            out2.vehicle_api.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("hos_api",
	(
		out2.hos_api != null?
            out2.hos_api.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("hos_api",
	(
		out2.hos_api != null?
            out2.hos_api.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("driver_api",
	(
		out2.driver_api != null?
            out2.driver_api.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("driver_api",
	(
		out2.driver_api != null?
            out2.driver_api.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("image_path",
	(
		out2.image_path != null?
            out2.image_path.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("image_path",
	(
		out2.image_path != null?
            out2.image_path.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("params",
	(
		out2.params != null?
            out2.params.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("params",
	(
		out2.params != null?
            out2.params.toString():null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_2_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("eld");
		if(
		valueMap_tWriteJSONField_2_Out.get("eld")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_2_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("eld"));
            root_2_tWriteJSONField_2_Out.addAttribute("type", "number");
		}
		org.dom4j.Element root_3_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("name");
		if(
		...
		org.dom4j.Element root_4_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("display_name");
		if(
		valueMap_tWriteJSONField_2_Out.get("display_name")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_4_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("display_name"));
		}
		org.dom4j.Element root_5_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("location_api");
		if(
		valueMap_tWriteJSONField_2_Out.get("location_api")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_5_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("location_api"));
		}
		org.dom4j.Element root_6_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("vehicle_api");
		if(
		valueMap_tWriteJSONField_2_Out.get("vehicle_api")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_6_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("vehicle_api"));
		}
		org.dom4j.Element root_7_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("hos_api");
		if(
		valueMap_tWriteJSONField_2_Out.get("hos_api")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_7_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("hos_api"));
		}
		org.dom4j.Element root_8_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("driver_api");
		if(
		valueMap_tWriteJSONField_2_Out.get("driver_api")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_8_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("driver_api"));
		}
		org.dom4j.Element root_9_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("image_path");
		if(
		valueMap_tWriteJSONField_2_Out.get("image_path")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_9_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("image_path"));
		}
		org.dom4j.Element root_10_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("params");
		if(
		valueMap_tWriteJSONField_2_Out.get("params")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_10_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("params"));
		}
		org.dom4j.Element root_11_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("current_date");
		if(
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_D_HDO_elds_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tConvertType_1";
      ...
      globalMap.put("tConvertType_1_NB_LINE", nb_line_tConvertType_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"conv1");
			  	}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_D_HDO_elds_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_D_HDO_elds_" + pid + "_tHashOutput_2";
 ...
 */
    ...
    public static void main(String[] args){
        final D_HDO_elds D_HDO_eldsClass = new D_HDO_elds();

        int exitCode = D_HDO_eldsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = D_HDO_elds.class.getClassLoader().getResourceAsStream("test/d_hdo_elds_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = D_HDO_elds.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : D_HDO_elds");
        }
...
/************************************************************************************************
 *     276704 characters generated by Talend Open Studio for Data Integration 
