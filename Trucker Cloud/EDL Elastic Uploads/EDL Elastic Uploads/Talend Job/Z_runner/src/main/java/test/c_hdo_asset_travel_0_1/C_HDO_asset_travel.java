...
package test.c_hdo_asset_travel_0_1;
...
/**
 * Job: C_HDO_asset_travel Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20190924_1038-M2
 * @status 
 */
public class C_HDO_asset_travel implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "C_HDO_asset_travel";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				C_HDO_asset_travel.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(C_HDO_asset_travel.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_TEST_C_HDO_asset_travel = new byte[0];
    static byte[] commonByteArray_TEST_C_HDO_asset_travel = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_C_HDO_asset_travel.length) {
				if(length < 1024 && commonByteArray_TEST_C_HDO_asset_travel.length == 0) {
   					commonByteArray_TEST_C_HDO_asset_travel = new byte[1024];
				} else {
   					commonByteArray_TEST_C_HDO_asset_travel = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_C_HDO_asset_travel, 0, length);
			strReturn = new String(commonByteArray_TEST_C_HDO_asset_travel, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_C_HDO_asset_travel) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_asset_travel/HDO_asset_travel.json")).getAbsolutePath().replace("\\","/");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_C_HDO_asset_travel_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_C_HDO_asset_travel_" + pid +"_tHashOutput_1");
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_asset_travel_index" ,env_tSystem_1);
...
try{
    ...
    int bos_buffer_tHttpRequest_1 = 0;
            java.io.InputStream bisParam_tHttpRequest_1 = new java.io.BufferedInputStream(new java.io.FileInputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_asset_travelFRH.json"));
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_1) {
        java.io.InputStream bis_tHttpRequest_1 = new java.io.BufferedInputStream(urlConn_tHttpRequest_1.getInputStream());
                java.io.File bosParent_tHttpRequest_1 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_asset_travel_error.json").getParentFile();
                if (bosParent_tHttpRequest_1 != null && bosParent_tHttpRequest_1.exists() == false){
                    bosParent_tHttpRequest_1.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_1 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_asset_travel_error.json"));
...
public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_2 = "D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_asset_travel";
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_2 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_2.add("HDO_asset_travel*.json");  
...
try{
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_2) {
        java.io.InputStream bis_tHttpRequest_2 = new java.io.BufferedInputStream(urlConn_tHttpRequest_2.getInputStream());
                java.io.File bosParent_tHttpRequest_2 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_asset_travel/Error/HDO_tc_asset_travel_Error"+Numeric.sequence("z1",0,1)+".json").getParentFile();
                if (bosParent_tHttpRequest_2 != null && bosParent_tHttpRequest_2.exists() == false){
                    bosParent_tHttpRequest_2.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_2 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_asset_travel/Error/HDO_tc_asset_travel_Error"+Numeric.sequence("z1",0,1)+".json"));
...
final Process ps_tSystem_2 = runtime_tSystem_2.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_asset_travel_index/_doc/1?pretty" ,env_tSystem_2);
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_C_HDO_asset_travel_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_C_HDO_asset_travel_" + pid +"_tHashOutput_2");
...
public void tFileList_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_3 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_3.add("*asset_travel*.xlsx");  
...
public static class copyOfout1Struct implements routines.system.IPersistableRow<copyOfout1Struct> {
    ...
    static byte[] commonByteArray_TEST_C_HDO_asset_travel = new byte[0];
			    ...
			    public String gpsMiles;

				public String getGpsMiles () {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_C_HDO_asset_travel_" + pid + "_tHashOutput_3";
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				curColName_tFileInputExcel_2 = "gpsMiles";

				row2.gpsMiles = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.gpsMiles = null;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "start_date";
				...
				if(2<actual_end_column_tFileInputExcel_2){
					try{
						if(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2))){
							row2.start_date = row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_2 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], "yyyy-MM-dd");
                            if(tempDate_tFileInputExcel_2.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_2.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row2.start_date = tempDate_tFileInputExcel_2;
                            }
						}
					}catch(java.lang.Exception e){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "end_date";

				if(3<actual_end_column_tFileInputExcel_2){
					try{
						if(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2))){
							row2.end_date = row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_2 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], "yyyy-MM-dd");
                            if(tempDate_tFileInputExcel_2.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_2.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row2.end_date = tempDate_tFileInputExcel_2;
                            }
						}
					}catch(java.lang.Exception e){
...
copyOfout1_tmp.gpsMiles = row2.gpsMiles ;
copyOfout1_tmp.assetEldId = row2.assetEldId ;
copyOfout1_tmp.start_date = row2.start_date ;
copyOfout1_tmp.end_date = row2.end_date ;
...
if(copyOfout1 != null) { 
	...
	currentComponent="tHashOutput_3";
		...
		copyOfout1Struct oneRow_tHashOutput_3 = new copyOfout1Struct();
					...
					oneRow_tHashOutput_3.gpsMiles = copyOfout1.gpsMiles;
					oneRow_tHashOutput_3.assetEldId = copyOfout1.assetEldId;
					oneRow_tHashOutput_3.start_date = copyOfout1.start_date;
					oneRow_tHashOutput_3.end_date = copyOfout1.end_date;
...
public static class idStruct implements routines.system.IPersistableRow<idStruct> {
    final static byte[] commonByteArrayLock_TEST_C_HDO_asset_travel = new byte[0];
    static byte[] commonByteArray_TEST_C_HDO_asset_travel = new byte[0];
			    ...
			    public String gps_miles;

				public String getGps_miles () {
					return this.gps_miles;
				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.gps_miles,dos);
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
    ...
    static byte[] commonByteArray_TEST_C_HDO_asset_travel = new byte[0];
			    ...
			    public Double gpsMiles;

				public Double getGpsMiles () {
					return this.gpsMiles;
				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Double
						...
						if(this.gpsMiles == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.gpsMiles);
		            	}
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("gpsMiles="+String.valueOf(gpsMiles));
		sb.append(",assetEldId="+assetEldId);
		sb.append(",start_date="+String.valueOf(start_date));
		sb.append(",end_date="+String.valueOf(end_date));
	    sb.append("]");
 ...
 */
	...
	currentComponent="tWriteJSONField_2_Out";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"id");
					}
...
idStruct  rowStructOutput_tWriteJSONField_2_Out = new idStruct();
// sort group root element for judgement of group
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<copyOfout1Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_C_HDO_asset_travel_" + pid +"_tHashOutput_3");
...
while (iterator_tHashInput_3.hasNext()) {
	...
	row1.gpsMiles = next_tHashInput_3.gpsMiles;
	row1.assetEldId = next_tHashInput_3.assetEldId;
	row1.start_date = next_tHashInput_3.start_date;
	row1.end_date = next_tHashInput_3.end_date;
...
// # Output table : 'out1'
out1_tmp.gpsMiles = row1.gpsMiles ;
out1_tmp.assetEldId = row1.assetEldId ;
out1_tmp.start_date = row1.start_date ;
out1_tmp.end_date = row1.end_date ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          try {
              out2.gpsMiles=TypeConvert.String2Double(out1.gpsMiles);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out2.assetEldId=TypeConvert.String2String(out1.assetEldId);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out2.start_date=TypeConvert.Date2Date(out1.start_date);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out2.end_date=TypeConvert.Date2Date(out1.end_date);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }
      if (bHasError_tConvertType_1) {out2 = null;}
...
// # Output table : 'out4'
out4_tmp._index = "eos_hdo_tc_prod_asset_travel_index" ;
...
id_tmp.id = Var.var1 ;
id_tmp.org_id = 1835;
id_tmp.account_id = 1835;
id_tmp.current_date = Var.var2;
id_tmp.id2 = Var.var1 ;
id_tmp.gps_miles = out1.gpsMiles ;
id_tmp.asset_eld_id = out1.assetEldId ;
id_tmp.start_date = out1.start_date ;
id_tmp.end_date = out1.end_date ;
id = id_tmp;
// ###############################
...
if(id != null) { 
	...
	currentComponent="tWriteJSONField_2_Out";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"id");
					}
	...
	(
		id.current_date != null?
            FormatterUtils.format_Date(id.current_date,"yyyy/MM/dd"):null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("gps_miles",
	(
		id.gps_miles != null?
            id.gps_miles.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("gps_miles",
	(
		id.gps_miles != null?
            id.gps_miles.toString():null
		));
	...
	(
		id.asset_eld_id != null?
            id.asset_eld_id.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("start_date",
	(
		id.start_date != null?
            FormatterUtils.format_Date(id.start_date,"yyyy/MM/dd"):null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("start_date",
	(
		id.start_date != null?
            FormatterUtils.format_Date(id.start_date,"yyyy/MM/dd"):null
		));
	valueMap_tWriteJSONField_2_Out.put("end_date",
	(
		id.end_date != null?
            FormatterUtils.format_Date(id.end_date,"yyyy/MM/dd"):null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("end_date",
	(
		id.end_date != null?
            FormatterUtils.format_Date(id.end_date,"yyyy/MM/dd"):null
		));
	...
	if(strCompCache_tWriteJSONField_2_Out==null){
		strCompCache_tWriteJSONField_2_Out=strTemp_tWriteJSONField_2_Out;
            	...
            	rowStructOutput_tWriteJSONField_2_Out.id = id.id;
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_2_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("gps_miles");
		if(
		valueMap_tWriteJSONField_2_Out.get("gps_miles")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_2_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("gps_miles"));
		}
		org.dom4j.Element root_3_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("asset_eld_id");
		if(
		...
		org.dom4j.Element root_4_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("start_date");
		if(
		valueMap_tWriteJSONField_2_Out.get("start_date")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_4_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("start_date"));
		}
		org.dom4j.Element root_5_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("end_date");
		if(
		valueMap_tWriteJSONField_2_Out.get("end_date")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_5_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("end_date"));
		}
		org.dom4j.Element root_6_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("current_date");
		if(
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_C_HDO_asset_travel_" + pid +"_tHashOutput_3");
...
resourceMap.put("finish_tWriteJSONField_2_Out", true);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"id");
			  	}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_C_HDO_asset_travel_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_C_HDO_asset_travel_" + pid + "_tHashOutput_2";
 ...
 */
    ...
    public static void main(String[] args){
        final C_HDO_asset_travel C_HDO_asset_travelClass = new C_HDO_asset_travel();

        int exitCode = C_HDO_asset_travelClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = C_HDO_asset_travel.class.getClassLoader().getResourceAsStream("test/c_hdo_asset_travel_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = C_HDO_asset_travel.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : C_HDO_asset_travel");
        }
...
/************************************************************************************************
 *     268624 characters generated by Talend Open Studio for Data Integration 
