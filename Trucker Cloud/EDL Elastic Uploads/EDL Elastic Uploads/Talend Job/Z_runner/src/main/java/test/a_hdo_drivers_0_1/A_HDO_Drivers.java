...
package test.a_hdo_drivers_0_1;
...
/**
 * Job: A_HDO_Drivers Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20190924_1038-M2
 * @status 
 */
public class A_HDO_Drivers implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(CurrentDate != null){
					...
					String pattern_CurrentDate = "yyyy-MM-dd HH:mm:ss";
					String value_CurrentDate = "TalendDate.getCurrentDate()";
					String[] parts_CurrentDate = value_CurrentDate.split(";");
					if(parts_CurrentDate.length > 1){
						pattern_CurrentDate = parts_CurrentDate[0];
						this.setProperty("CurrentDate", pattern_CurrentDate + ";" + FormatterUtils.format_Date(CurrentDate, pattern_CurrentDate));
					}else{
						this.setProperty("CurrentDate", FormatterUtils.format_Date(CurrentDate, pattern_CurrentDate));
					}
...
public java.util.Date getCurrentDate(){
	...
	private final String jobName = "A_HDO_Drivers";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				A_HDO_Drivers.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(A_HDO_Drivers.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tFileUnarchive_1_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public void tFileUnarchive_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tFileUnarchive_1";
        ...
        String zipFileURL_tFileUnarchive_1 = "D:/HDO/EDL Elastic Uploads/Input/"+TalendDate.formatDate("yyyy-MM-dd",TalendDate.getCurrentDate())+".zip";
        String tmpFileURL_tFileUnarchive_1 = zipFileURL_tFileUnarchive_1.toLowerCase();
        String outputPath_tFileUnarchive_1 = "D:/HDO/EDL Elastic Uploads/Input";

       boolean isValidArchive_tFileUnarchive_1 = true;
       if(
          tmpFileURL_tFileUnarchive_1.endsWith(".tar.gz")
       || tmpFileURL_tFileUnarchive_1.endsWith(".tgz")
       || tmpFileURL_tFileUnarchive_1.endsWith(".gz")
       ){
           isValidArchive_tFileUnarchive_1 = org.talend.archive.IntegrityUtil.isGZIPValid(zipFileURL_tFileUnarchive_1);

       }else if(tmpFileURL_tFileUnarchive_1.endsWith(".tar")){
       		isValidArchive_tFileUnarchive_1 = org.talend.archive.IntegrityUtil.isTarValid(zipFileURL_tFileUnarchive_1);
       }
       if(!isValidArchive_tFileUnarchive_1){
            throw new RuntimeException ("The file " + zipFileURL_tFileUnarchive_1 + " is corrupted, process terminated..." );
              }
	...
	final String decryptedPassword_tFileUnarchive_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[3wsOMnbk/woqdy5ZsU6GMg==]");

        unzip_tFileUnarchive_1.setPassword(decryptedPassword_tFileUnarchive_1);
        unzip_tFileUnarchive_1.setCheckArchive(true);
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileUnarchive_1:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public void tFileList_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_3 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_3.add("*drivers*.xlsx");  
...
public static class out3Struct implements routines.system.IPersistableRow<out3Struct> {
    final static byte[] commonByteArrayLock_TEST_A_HDO_Drivers = new byte[0];
    static byte[] commonByteArray_TEST_A_HDO_Drivers = new byte[0];
			    ...
			    public String eldVendor;

				public String getEldVendor () {
					return this.eldVendor;
				}
				
			    public String eldDriverId;

				public String getEldDriverId () {
					return this.eldDriverId;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_A_HDO_Drivers.length) {
				if(length < 1024 && commonByteArray_TEST_A_HDO_Drivers.length == 0) {
   					commonByteArray_TEST_A_HDO_Drivers = new byte[1024];
				} else {
   					commonByteArray_TEST_A_HDO_Drivers = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_A_HDO_Drivers, 0, length);
			strReturn = new String(commonByteArray_TEST_A_HDO_Drivers, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_A_HDO_Drivers) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.codeType = readString(dis);
					
					this.carrierCode = readString(dis);
					
					this.eldVendor = readString(dis);
					
					this.eldDriverId = readString(dis);
					...
					this.licenseNumber = readString(dis);
					
					this.licenseState = readString(dis);
					
					this.licenseClass = readString(dis);
					
					this.licenseExpiry = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.codeType,dos);
					
					// String
				
						writeString(this.carrierCode,dos);
					
					// String
				
						writeString(this.eldVendor,dos);
					
					// String
				
						writeString(this.eldDriverId,dos);
					...
					// String
						...
						writeString(this.licenseNumber,dos);
					
					// String
				
						writeString(this.licenseState,dos);
					
					// String
				
						writeString(this.licenseClass,dos);
					
					// String
				
						writeString(this.licenseExpiry,dos);
    ...
    public String toString() {
		...
		sb.append(",codeType="+codeType);
		sb.append(",carrierCode="+carrierCode);
		sb.append(",eldVendor="+eldVendor);
		sb.append(",eldDriverId="+eldDriverId);
		sb.append(",firstName="+firstName);
		sb.append(",middleName="+middleName);
		sb.append(",lastName="+lastName);
		sb.append(",licenseNumber="+licenseNumber);
		sb.append(",licenseState="+licenseState);
		sb.append(",licenseClass="+licenseClass);
		sb.append(",licenseExpiry="+licenseExpiry);
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out3Struct> tHashFile_tHashOutput_3 = null;
		String hashKey_tHashOutput_3 = "tHashFile_A_HDO_Drivers_" + pid + "_tHashOutput_3";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_3)){
			    if(mf_tHashOutput_3.getResourceMap().get(hashKey_tHashOutput_3) == null){
	      		    mf_tHashOutput_3.getResourceMap().put(hashKey_tHashOutput_3, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out3Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
 ...
 */
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "codeType";

				row2.codeType = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.codeType = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "carrierCode";

				row2.carrierCode = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.carrierCode = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "eldVendor";

				row2.eldVendor = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.eldVendor = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "eldDriverId";

				row2.eldDriverId = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.eldDriverId = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "firstName";

				row2.firstName = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.firstName = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "middleName";

				row2.middleName = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "lastName";

				row2.lastName = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.lastName = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "licenseNumber";

				row2.licenseNumber = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.licenseNumber = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "licenseState";

				row2.licenseState = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.licenseState = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "licenseClass";

				row2.licenseClass = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.licenseClass = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "licenseExpiry";

				row2.licenseExpiry = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.licenseExpiry = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "phoneNumber";

				row2.phoneNumber = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.phoneNumber = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "emailId";

				row2.emailId = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.emailId = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "address1";

				row2.address1 = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.address1 = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "address2";

				row2.address2 = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.address2 = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row2.state = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.state = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "zipCode";

				row2.zipCode = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.zipCode = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
...
// # Output table : 'out3'
out3_tmp.carrierName = row2.carrierName ;
out3_tmp.codeType = row2.codeType ;
out3_tmp.carrierCode = row2.carrierCode ;
out3_tmp.eldVendor = row2.eldVendor ;
out3_tmp.eldDriverId = row2.eldDriverId ;
out3_tmp.firstName = row2.firstName ;
out3_tmp.middleName = row2.middleName ;
out3_tmp.lastName = row2.lastName ;
out3_tmp.licenseNumber = row2.licenseNumber ;
out3_tmp.licenseState = row2.licenseState ;
out3_tmp.licenseClass = row2.licenseClass ;
out3_tmp.licenseExpiry = row2.licenseExpiry ;
out3_tmp.phoneNumber = row2.phoneNumber ;
out3_tmp.emailId = row2.emailId ;
out3_tmp.address1 = row2.address1 ;
out3_tmp.address2 = row2.address2 ;
out3_tmp.city = row2.city ;
out3_tmp.state = row2.state ;
out3_tmp.zipCode = row2.zipCode ;
out3_tmp.status = row2.status ;
out3 = out3_tmp;
// ###############################
...
if(out3 != null) { 
	...
	currentComponent="tHashOutput_3";
		...
		out3Struct oneRow_tHashOutput_3 = new out3Struct();
				
					oneRow_tHashOutput_3.carrierName = out3.carrierName;
					oneRow_tHashOutput_3.codeType = out3.codeType;
					oneRow_tHashOutput_3.carrierCode = out3.carrierCode;
					oneRow_tHashOutput_3.eldVendor = out3.eldVendor;
					oneRow_tHashOutput_3.eldDriverId = out3.eldDriverId;
					oneRow_tHashOutput_3.firstName = out3.firstName;
					oneRow_tHashOutput_3.middleName = out3.middleName;
					oneRow_tHashOutput_3.lastName = out3.lastName;
					oneRow_tHashOutput_3.licenseNumber = out3.licenseNumber;
					oneRow_tHashOutput_3.licenseState = out3.licenseState;
					oneRow_tHashOutput_3.licenseClass = out3.licenseClass;
					oneRow_tHashOutput_3.licenseExpiry = out3.licenseExpiry;
					oneRow_tHashOutput_3.phoneNumber = out3.phoneNumber;
					oneRow_tHashOutput_3.emailId = out3.emailId;
					oneRow_tHashOutput_3.address1 = out3.address1;
					oneRow_tHashOutput_3.address2 = out3.address2;
					oneRow_tHashOutput_3.city = out3.city;
					oneRow_tHashOutput_3.state = out3.state;
					oneRow_tHashOutput_3.zipCode = out3.zipCode;
					oneRow_tHashOutput_3.status = out3.status;
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
		...
		synchronized(commonByteArrayLock_TEST_A_HDO_Drivers) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.license_class = readString(dis);
					
					this.license_expiry = readString(dis);
					
					this.phone_number = readString(dis);
					
					this.email_id = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.license_class,dos);
					
					// String
				
						writeString(this.license_expiry,dos);
    ...
    public String toString() {
		...
		sb.append(",license_class="+license_class);
		sb.append(",license_expiry="+license_expiry);
		sb.append(",phone_number="+phone_number);
		sb.append(",email_id="+email_id);
		sb.append(",address1="+address1);
		sb.append(",address2="+address2);
		sb.append(",city="+city);
		sb.append(",state="+state);
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out3Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_A_HDO_Drivers_" + pid +"_tHashOutput_3");
if(tHashFile_tHashInput_3==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<out3Struct> iterator_tHashInput_3 = tHashFile_tHashInput_3.iterator();
while (iterator_tHashInput_3.hasNext()) {
    out3Struct next_tHashInput_3 = iterator_tHashInput_3.next();

	row1.carrierName = next_tHashInput_3.carrierName;
	row1.codeType = next_tHashInput_3.codeType;
	row1.carrierCode = next_tHashInput_3.carrierCode;
	row1.eldVendor = next_tHashInput_3.eldVendor;
	row1.eldDriverId = next_tHashInput_3.eldDriverId;
	row1.firstName = next_tHashInput_3.firstName;
	row1.middleName = next_tHashInput_3.middleName;
	row1.lastName = next_tHashInput_3.lastName;
	row1.licenseNumber = next_tHashInput_3.licenseNumber;
	row1.licenseState = next_tHashInput_3.licenseState;
	row1.licenseClass = next_tHashInput_3.licenseClass;
	row1.licenseExpiry = next_tHashInput_3.licenseExpiry;
	row1.phoneNumber = next_tHashInput_3.phoneNumber;
	row1.emailId = next_tHashInput_3.emailId;
	row1.address1 = next_tHashInput_3.address1;
	row1.address2 = next_tHashInput_3.address2;
	row1.city = next_tHashInput_3.city;
	row1.state = next_tHashInput_3.state;
	row1.zipCode = next_tHashInput_3.zipCode;
...
out1_tmp.codeType = row1.codeType ;
out1_tmp.carrierCode = row1.carrierCode ;
out1_tmp.eldVendor = row1.eldVendor ;
out1_tmp.eldDriverId = row1.eldDriverId ;
out1_tmp.firstName = row1.firstName ;
out1_tmp.middleName = row1.middleName ;
out1_tmp.lastName = row1.lastName ;
out1_tmp.licenseNumber = row1.licenseNumber ;
out1_tmp.licenseState = row1.licenseState ;
out1_tmp.licenseClass = row1.licenseClass ;
out1_tmp.licenseExpiry = row1.licenseExpiry ;
out1_tmp.phoneNumber = row1.phoneNumber ;
out1_tmp.emailId = row1.emailId ;
out1_tmp.address1 = row1.address1 ;
out1_tmp.address2 = row1.address2 ;
out1_tmp.city = row1.city ;
out1_tmp.state = row1.state ;
out1_tmp.zipCode = row1.zipCode ;
...
// # Output table : 'out4'
out4_tmp._index = "eos_hdo_tc_prod_drivers_index" ;
...
out2_tmp.code_type = out1.codeType ;
out2_tmp.carrier_code = out1.carrierCode ;
out2_tmp.eld_vendor = out1.eldVendor ;
out2_tmp.eld_driver_id = out1.eldDriverId ;
out2_tmp.first_name = out1.firstName ;
out2_tmp.middle_name = out1.middleName ;
out2_tmp.last_name = out1.lastName ;
out2_tmp.license_number = out1.licenseNumber ;
out2_tmp.license_state = out1.licenseState ;
out2_tmp.license_class = out1.licenseClass ;
out2_tmp.license_expiry = out1.licenseExpiry ;
out2_tmp.phone_number = out1.phoneNumber ;
out2_tmp.email_id = out1.emailId ;
out2_tmp.address1 = out1.address1 ;
out2_tmp.address2 = out1.address2 ;
out2_tmp.city = out1.city ;
out2_tmp.state = out1.state ;
out2_tmp.zipcode = out1.zipCode ;
...
if(out2 != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("middle_name",
	(
		out2.middle_name != null?
            out2.middle_name.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("middle_name",
	(
		out2.middle_name != null?
            out2.middle_name.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("license_number",
	(
		out2.license_number != null?
            out2.license_number.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("license_number",
	(
		out2.license_number != null?
            out2.license_number.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("license_class",
	(
		out2.license_class != null?
            out2.license_class.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("license_class",
	(
		out2.license_class != null?
            out2.license_class.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("license_expiry",
	(
		out2.license_expiry != null?
            out2.license_expiry.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("license_expiry",
	(
		out2.license_expiry != null?
            out2.license_expiry.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("phone_number",
	(
		out2.phone_number != null?
            out2.phone_number.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("phone_number",
	(
		out2.phone_number != null?
            out2.phone_number.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("email_id",
	(
		out2.email_id != null?
            out2.email_id.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("email_id",
	(
		out2.email_id != null?
            out2.email_id.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("address1",
	(
		out2.address1 != null?
            out2.address1.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("address1",
	(
		out2.address1 != null?
            out2.address1.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("address2",
	(
		out2.address2 != null?
            out2.address2.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("address2",
	(
		out2.address2 != null?
            out2.address2.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("city",
	(
		out2.city != null?
            out2.city.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("city",
	(
		out2.city != null?
            out2.city.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("state",
	(
		out2.state != null?
            out2.state.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("state",
	(
		out2.state != null?
            out2.state.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("zipcode",
	(
		out2.zipcode != null?
            out2.zipcode.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("zipcode",
	(
		out2.zipcode != null?
            out2.zipcode.toString():null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_3_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("code_type");
		if(
		...
		org.dom4j.Element root_4_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("carrier_code");
		if(
		...
		org.dom4j.Element root_5_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("eld_vendor");
		if(
		...
		org.dom4j.Element root_6_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("eld_driver_id");
		if(
		...
		org.dom4j.Element root_7_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("first_name");
		if(
		...
		org.dom4j.Element root_8_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("middle_name");
		if(
		valueMap_tWriteJSONField_2_Out.get("middle_name")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_8_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("middle_name"));
		}
		...
		org.dom4j.Element root_10_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("license_number");
		if(
		valueMap_tWriteJSONField_2_Out.get("license_number")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_10_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("license_number"));
		}
		...
		org.dom4j.Element root_12_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("license_class");
		if(
		valueMap_tWriteJSONField_2_Out.get("license_class")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_12_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("license_class"));
		}
		org.dom4j.Element root_13_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("license_expiry");
		if(
		valueMap_tWriteJSONField_2_Out.get("license_expiry")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_13_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("license_expiry"));
		}
		org.dom4j.Element root_14_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("phone_number");
		if(
		valueMap_tWriteJSONField_2_Out.get("phone_number")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_14_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("phone_number"));
		}
		org.dom4j.Element root_15_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("email_id");
		if(
		valueMap_tWriteJSONField_2_Out.get("email_id")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_15_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("email_id"));
		}
		org.dom4j.Element root_16_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("address1");
		if(
		valueMap_tWriteJSONField_2_Out.get("address1")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_16_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("address1"));
		}
		org.dom4j.Element root_17_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("address2");
		if(
		valueMap_tWriteJSONField_2_Out.get("address2")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_17_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("address2"));
		}
		org.dom4j.Element root_18_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("city");
		if(
		valueMap_tWriteJSONField_2_Out.get("city")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_18_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("city"));
		}
		org.dom4j.Element root_19_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("state");
		if(
		valueMap_tWriteJSONField_2_Out.get("state")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_19_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("state"));
		}
		org.dom4j.Element root_20_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("zipcode");
		if(
		valueMap_tWriteJSONField_2_Out.get("zipcode")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_20_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("zipcode"));
		}
		org.dom4j.Element root_21_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("status");
		if(
		...
		org.dom4j.Element root_22_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("current_date");
		if(
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_A_HDO_Drivers_" + pid +"_tHashOutput_3");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_drivers/HDO_drivers.json")).getAbsolutePath().replace("\\","/");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_A_HDO_Drivers_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_A_HDO_Drivers_" + pid +"_tHashOutput_1");
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_drivers_index" ,env_tSystem_1);
...
try{
    ...
    int bos_buffer_tHttpRequest_1 = 0;
            java.io.InputStream bisParam_tHttpRequest_1 = new java.io.BufferedInputStream(new java.io.FileInputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_driversFRH.json"));
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_1) {
        java.io.InputStream bis_tHttpRequest_1 = new java.io.BufferedInputStream(urlConn_tHttpRequest_1.getInputStream());
                java.io.File bosParent_tHttpRequest_1 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_driver_first_row_error.json").getParentFile();
                if (bosParent_tHttpRequest_1 != null && bosParent_tHttpRequest_1.exists() == false){
                    bosParent_tHttpRequest_1.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_1 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_driver_first_row_error.json"));
...
public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_2 = "D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_drivers";
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_2 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_2.add("HDO_drivers*.json");  
...
try{
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_2) {
        java.io.InputStream bis_tHttpRequest_2 = new java.io.BufferedInputStream(urlConn_tHttpRequest_2.getInputStream());
                java.io.File bosParent_tHttpRequest_2 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_drivers/Error/HDO_tc_drivers_Error"+Numeric.sequence("z1",0,1)+".json").getParentFile();
                if (bosParent_tHttpRequest_2 != null && bosParent_tHttpRequest_2.exists() == false){
                    bosParent_tHttpRequest_2.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_2 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_drivers/Error/HDO_tc_drivers_Error"+Numeric.sequence("z1",0,1)+".json"));
...
final Process ps_tSystem_2 = runtime_tSystem_2.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_drivers_index/_doc/1?pretty" ,env_tSystem_2);
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_A_HDO_Drivers_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_A_HDO_Drivers_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_A_HDO_Drivers_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_A_HDO_Drivers_" + pid + "_tHashOutput_2";
 ...
 */
    ...
    public static void main(String[] args){
        final A_HDO_Drivers A_HDO_DriversClass = new A_HDO_Drivers();

        int exitCode = A_HDO_DriversClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = A_HDO_Drivers.class.getClassLoader().getResourceAsStream("test/a_hdo_drivers_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = A_HDO_Drivers.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("CurrentDate", "id_Date");
                        try{
                            String context_CurrentDate_value = context.getProperty("CurrentDate");
                            if (context_CurrentDate_value == null){
                                context_CurrentDate_value = "";
                            }
                            int context_CurrentDate_pos = context_CurrentDate_value.indexOf(";");
                            String context_CurrentDate_pattern =  "yyyy-MM-dd HH:mm:ss";
                            if(context_CurrentDate_pos > -1){
                                context_CurrentDate_pattern = context_CurrentDate_value.substring(0, context_CurrentDate_pos);
                                context_CurrentDate_value = context_CurrentDate_value.substring(context_CurrentDate_pos + 1);
                            }

                            context.CurrentDate=(java.util.Date)(new java.text.SimpleDateFormat(context_CurrentDate_pattern).parse(context_CurrentDate_value));

                        } catch(ParseException e) {
                                System.err.println(String.format("Null value will be used for context parameter %s: %s", "CurrentDate", e.getMessage()));
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("CurrentDate")) {
                context.CurrentDate = (java.util.Date) parentContextMap.get("CurrentDate");
            }
        }
...
try {
errorCode = null;tFileUnarchive_1Process(globalMap);
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : A_HDO_Drivers");
        }
...
/************************************************************************************************
 *     308723 characters generated by Talend Open Studio for Data Integration 
 *     on the August 8, 2024 1:11:04 PM IST
 ************************************************************************************************/