...
package test.g_hdo_safety_events_0_1;
...
/**
 * Job: G_HDO_safety_events Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20190924_1038-M2
 * @status 
 */
public class G_HDO_safety_events implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "G_HDO_safety_events";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				G_HDO_safety_events.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(G_HDO_safety_events.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_TEST_G_HDO_safety_events = new byte[0];
    static byte[] commonByteArray_TEST_G_HDO_safety_events = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_G_HDO_safety_events.length) {
				if(length < 1024 && commonByteArray_TEST_G_HDO_safety_events.length == 0) {
   					commonByteArray_TEST_G_HDO_safety_events = new byte[1024];
				} else {
   					commonByteArray_TEST_G_HDO_safety_events = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_G_HDO_safety_events, 0, length);
			strReturn = new String(commonByteArray_TEST_G_HDO_safety_events, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_G_HDO_safety_events) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_safety_events/HDO_safety_events.json")).getAbsolutePath().replace("\\","/");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_G_HDO_safety_events_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_G_HDO_safety_events_" + pid +"_tHashOutput_1");
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_safety_events_index" ,env_tSystem_1);
...
try{
    ...
    int bos_buffer_tHttpRequest_1 = 0;
            java.io.InputStream bisParam_tHttpRequest_1 = new java.io.BufferedInputStream(new java.io.FileInputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_safety_eventsFRH.json"));
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_1) {
        java.io.InputStream bis_tHttpRequest_1 = new java.io.BufferedInputStream(urlConn_tHttpRequest_1.getInputStream());
                java.io.File bosParent_tHttpRequest_1 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_safety_events_first_row_error.json").getParentFile();
                if (bosParent_tHttpRequest_1 != null && bosParent_tHttpRequest_1.exists() == false){
                    bosParent_tHttpRequest_1.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_1 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_safety_events_first_row_error.json"));
...
public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_2 = "D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_safety_events";
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_2 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_2.add("HDO_safety_events*.json");  
...
try{
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_2) {
        java.io.InputStream bis_tHttpRequest_2 = new java.io.BufferedInputStream(urlConn_tHttpRequest_2.getInputStream());
                java.io.File bosParent_tHttpRequest_2 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_Vehicle_asset_drivers/Error/HDO_tc_veh__asset_Error"+Numeric.sequence("z1",0,1)+".json").getParentFile();
                if (bosParent_tHttpRequest_2 != null && bosParent_tHttpRequest_2.exists() == false){
                    bosParent_tHttpRequest_2.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_2 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_Vehicle_asset_drivers/Error/HDO_tc_veh__asset_Error"+Numeric.sequence("z1",0,1)+".json"));
...
final Process ps_tSystem_2 = runtime_tSystem_2.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_safety_events_index/_doc/1?pretty" ,env_tSystem_2);
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_G_HDO_safety_events_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_G_HDO_safety_events_" + pid +"_tHashOutput_2");
...
public void tFileList_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_3 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_3.add("*safety_events*.xlsx");  
...
public static class copyOfout1Struct implements routines.system.IPersistableRow<copyOfout1Struct> {
    ...
    static byte[] commonByteArray_TEST_G_HDO_safety_events = new byte[0];
			    ...
			    public String rawData_id;

				public String getRawData_id () {
					return this.rawData_id;
				}
				
			    public String rawData_driver_id;

				public String getRawData_driver_id () {
					return this.rawData_driver_id;
				}
				
			    public String rawData_driver_name;

				public String getRawData_driver_name () {
					return this.rawData_driver_name;
				}
				
			    public String rawData_vehicle_id;

				public String getRawData_vehicle_id () {
					return this.rawData_vehicle_id;
				}
				
			    public String rawData_vehicle_name;

				public String getRawData_vehicle_name () {
					return this.rawData_vehicle_name;
				}
				
			    public String rawData_time;

				public String getRawData_time () {
					return this.rawData_time;
				}
				
			    public String rawData_maxAccelerationGForce;

				public String getRawData_maxAccelerationGForce () {
					return this.rawData_maxAccelerationGForce;
				}
				
			    public String rawData_downloadForwardVideoUrl;

				public String getRawData_downloadForwardVideoUrl () {
					return this.rawData_downloadForwardVideoUrl;
				}
				
			    public String rawData_downloadInwardVideoUrl;

				public String getRawData_downloadInwardVideoUrl () {
					return this.rawData_downloadInwardVideoUrl;
				}
				
			    public String rawData_downloadTrackedInwardVideoUrl;

				public String getRawData_downloadTrackedInwardVideoUrl () {
					return this.rawData_downloadTrackedInwardVideoUrl;
				}
				
			    public String rawData_location_latitude;

				public String getRawData_location_latitude () {
					return this.rawData_location_latitude;
				}
				
			    public String rawData_location_longitude;

				public String getRawData_location_longitude () {
					return this.rawData_location_longitude;
				}
				
			    public String rawData_coachingState;

				public String getRawData_coachingState () {
					return this.rawData_coachingState;
				}
				
			    public String rawData_behaviorLabels_label;

				public String getRawData_behaviorLabels_label () {
					return this.rawData_behaviorLabels_label;
				}
				
			    public String rawData_behaviorLabels_source;

				public String getRawData_behaviorLabels_source () {
					return this.rawData_behaviorLabels_source;
				}
				
			    public String rawData_behaviorLabels_name;

				public String getRawData_behaviorLabels_name () {
					return this.rawData_behaviorLabels_name;
				}
			    ...
			    public String gForceInfo_eventDateTime;

				public String getGForceInfo_eventDateTime () {
					return this.gForceInfo_eventDateTime;
				}
				
			    public String gForceInfo_gForce;

				public String getGForceInfo_gForce () {
					return this.gForceInfo_gForce;
				}
				
			    public String rawData_driver;

				public String getRawData_driver () {
					return this.rawData_driver;
				}
		...
		synchronized(commonByteArrayLock_TEST_G_HDO_safety_events) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.driverName = readString(dis);
					
					this.eventType = readString(dis);
					
					this.startTimeEvent = readString(dis);
					
					this.vehicleId = readString(dis);
					
					this.rawData_id = readString(dis);
					
					this.rawData_driver_id = readString(dis);
					
					this.rawData_driver_name = readString(dis);
					
					this.rawData_vehicle_id = readString(dis);
					
					this.rawData_vehicle_name = readString(dis);
					
					this.rawData_time = readString(dis);
					
					this.rawData_maxAccelerationGForce = readString(dis);
					
					this.rawData_downloadForwardVideoUrl = readString(dis);
					
					this.rawData_downloadInwardVideoUrl = readString(dis);
					
					this.rawData_downloadTrackedInwardVideoUrl = readString(dis);
					
					this.rawData_location_latitude = readString(dis);
					
					this.rawData_location_longitude = readString(dis);
					
					this.rawData_coachingState = readString(dis);
					
					this.rawData_behaviorLabels_label = readString(dis);
					
					this.rawData_behaviorLabels_source = readString(dis);
					
					this.rawData_behaviorLabels_name = readString(dis);
					
					this.latitude = readString(dis);
					
					this.longitude = readString(dis);
					
					this.gForceInfo_eventDateTime = readString(dis);
					
					this.gForceInfo_gForce = readString(dis);
					
					this.rawData_driver = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.driverName,dos);
					...
					// String
						...
						writeString(this.startTimeEvent,dos);
					
					// String
				
						writeString(this.vehicleId,dos);
					
					// String
				
						writeString(this.rawData_id,dos);
					
					// String
				
						writeString(this.rawData_driver_id,dos);
					
					// String
				
						writeString(this.rawData_driver_name,dos);
					
					// String
				
						writeString(this.rawData_vehicle_id,dos);
					
					// String
				
						writeString(this.rawData_vehicle_name,dos);
					
					// String
				
						writeString(this.rawData_time,dos);
					
					// String
				
						writeString(this.rawData_maxAccelerationGForce,dos);
					
					// String
				
						writeString(this.rawData_downloadForwardVideoUrl,dos);
					
					// String
				
						writeString(this.rawData_downloadInwardVideoUrl,dos);
					
					// String
				
						writeString(this.rawData_downloadTrackedInwardVideoUrl,dos);
					
					// String
				
						writeString(this.rawData_location_latitude,dos);
					
					// String
				
						writeString(this.rawData_location_longitude,dos);
					
					// String
				
						writeString(this.rawData_coachingState,dos);
					
					// String
				
						writeString(this.rawData_behaviorLabels_label,dos);
					
					// String
				
						writeString(this.rawData_behaviorLabels_source,dos);
					
					// String
				
						writeString(this.rawData_behaviorLabels_name,dos);
					...
					// String
						...
						writeString(this.gForceInfo_eventDateTime,dos);
					
					// String
				
						writeString(this.gForceInfo_gForce,dos);
					
					// String
				
						writeString(this.rawData_driver,dos);
    ...
    public String toString() {
		...
		sb.append(",startTimeEvent="+startTimeEvent);
		sb.append(",vehicleId="+vehicleId);
		sb.append(",rawData_id="+rawData_id);
		sb.append(",rawData_driver_id="+rawData_driver_id);
		sb.append(",rawData_driver_name="+rawData_driver_name);
		sb.append(",rawData_vehicle_id="+rawData_vehicle_id);
		sb.append(",rawData_vehicle_name="+rawData_vehicle_name);
		sb.append(",rawData_time="+rawData_time);
		sb.append(",rawData_maxAccelerationGForce="+rawData_maxAccelerationGForce);
		sb.append(",rawData_downloadForwardVideoUrl="+rawData_downloadForwardVideoUrl);
		sb.append(",rawData_downloadInwardVideoUrl="+rawData_downloadInwardVideoUrl);
		sb.append(",rawData_downloadTrackedInwardVideoUrl="+rawData_downloadTrackedInwardVideoUrl);
		sb.append(",rawData_location_latitude="+rawData_location_latitude);
		sb.append(",rawData_location_longitude="+rawData_location_longitude);
		sb.append(",rawData_coachingState="+rawData_coachingState);
		sb.append(",rawData_behaviorLabels_label="+rawData_behaviorLabels_label);
		sb.append(",rawData_behaviorLabels_source="+rawData_behaviorLabels_source);
		sb.append(",rawData_behaviorLabels_name="+rawData_behaviorLabels_name);
		sb.append(",latitude="+latitude);
		sb.append(",longitude="+longitude);
		sb.append(",gForceInfo_eventDateTime="+gForceInfo_eventDateTime);
		sb.append(",gForceInfo_gForce="+gForceInfo_gForce);
		sb.append(",rawData_driver="+rawData_driver);
	    sb.append("]");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_G_HDO_safety_events_" + pid + "_tHashOutput_3";
 ...
 */
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
		    ...
		    row9 = null;
					int tempRowLength_tFileInputExcel_2 = 26;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				curColName_tFileInputExcel_2 = "driverId";

				row9.driverId = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.driverId = null;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "driverName";

				row9.driverName = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.driverName = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "eventType";

				row9.eventType = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.eventType = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "startTimeEvent";

				row9.startTimeEvent = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.startTimeEvent = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "vehicleId";

				row9.vehicleId = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.vehicleId = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_id";

				row9.rawData_id = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_id = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_driver_id";

				row9.rawData_driver_id = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_driver_id = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_driver_name";

				row9.rawData_driver_name = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_driver_name = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_vehicle_id";

				row9.rawData_vehicle_id = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_vehicle_id = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_vehicle_name";

				row9.rawData_vehicle_name = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_vehicle_name = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_time";

				row9.rawData_time = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_time = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_maxAccelerationGForce";

				row9.rawData_maxAccelerationGForce = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_maxAccelerationGForce = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_downloadForwardVideoUrl";

				row9.rawData_downloadForwardVideoUrl = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_downloadForwardVideoUrl = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_downloadInwardVideoUrl";

				row9.rawData_downloadInwardVideoUrl = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_downloadInwardVideoUrl = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_downloadTrackedInwardVideoUrl";

				row9.rawData_downloadTrackedInwardVideoUrl = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_downloadTrackedInwardVideoUrl = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_location_latitude";

				row9.rawData_location_latitude = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_location_latitude = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_location_longitude";

				row9.rawData_location_longitude = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_location_longitude = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_coachingState";

				row9.rawData_coachingState = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_coachingState = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_behaviorLabels_label";

				row9.rawData_behaviorLabels_label = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_behaviorLabels_label = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_behaviorLabels_source";

				row9.rawData_behaviorLabels_source = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_behaviorLabels_source = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_behaviorLabels_name";

				row9.rawData_behaviorLabels_name = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_behaviorLabels_name = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row9.latitude = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.latitude = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row9.longitude = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.longitude = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "gForceInfo_eventDateTime";

				row9.gForceInfo_eventDateTime = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.gForceInfo_eventDateTime = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "gForceInfo_gForce";

				row9.gForceInfo_gForce = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.gForceInfo_gForce = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "rawData_driver";

				row9.rawData_driver = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row9.rawData_driver = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
...
copyOfout1_tmp.driverId = row9.driverId ;
copyOfout1_tmp.driverName = row9.driverName ;
copyOfout1_tmp.eventType = row9.eventType ;
copyOfout1_tmp.startTimeEvent = row9.startTimeEvent ;
copyOfout1_tmp.vehicleId = row9.vehicleId ;
copyOfout1_tmp.rawData_id = row9.rawData_id ;
copyOfout1_tmp.rawData_driver_id = row9.rawData_driver_id ;
copyOfout1_tmp.rawData_driver_name = row9.rawData_driver_name ;
copyOfout1_tmp.rawData_vehicle_id = row9.rawData_vehicle_id ;
copyOfout1_tmp.rawData_vehicle_name = row9.rawData_vehicle_name ;
copyOfout1_tmp.rawData_time = row9.rawData_time ;
copyOfout1_tmp.rawData_maxAccelerationGForce = row9.rawData_maxAccelerationGForce ;
copyOfout1_tmp.rawData_downloadForwardVideoUrl = row9.rawData_downloadForwardVideoUrl ;
copyOfout1_tmp.rawData_downloadInwardVideoUrl = row9.rawData_downloadInwardVideoUrl ;
copyOfout1_tmp.rawData_downloadTrackedInwardVideoUrl = row9.rawData_downloadTrackedInwardVideoUrl ;
copyOfout1_tmp.rawData_location_latitude = row9.rawData_location_latitude ;
copyOfout1_tmp.rawData_location_longitude = row9.rawData_location_longitude ;
copyOfout1_tmp.rawData_coachingState = row9.rawData_coachingState ;
copyOfout1_tmp.rawData_behaviorLabels_label = row9.rawData_behaviorLabels_label ;
copyOfout1_tmp.rawData_behaviorLabels_source = row9.rawData_behaviorLabels_source ;
copyOfout1_tmp.rawData_behaviorLabels_name = row9.rawData_behaviorLabels_name ;
copyOfout1_tmp.latitude = row9.latitude ;
copyOfout1_tmp.longitude = row9.longitude ;
copyOfout1_tmp.gForceInfo_eventDateTime = row9.gForceInfo_eventDateTime ;
copyOfout1_tmp.gForceInfo_gForce = row9.gForceInfo_gForce ;
copyOfout1_tmp.rawData_driver = row9.rawData_driver ;
...
if(copyOfout1 != null) { 
	...
	currentComponent="tHashOutput_3";
		...
		copyOfout1Struct oneRow_tHashOutput_3 = new copyOfout1Struct();
					...
					oneRow_tHashOutput_3.driverId = copyOfout1.driverId;
					oneRow_tHashOutput_3.driverName = copyOfout1.driverName;
					oneRow_tHashOutput_3.eventType = copyOfout1.eventType;
					oneRow_tHashOutput_3.startTimeEvent = copyOfout1.startTimeEvent;
					oneRow_tHashOutput_3.vehicleId = copyOfout1.vehicleId;
					oneRow_tHashOutput_3.rawData_id = copyOfout1.rawData_id;
					oneRow_tHashOutput_3.rawData_driver_id = copyOfout1.rawData_driver_id;
					oneRow_tHashOutput_3.rawData_driver_name = copyOfout1.rawData_driver_name;
					oneRow_tHashOutput_3.rawData_vehicle_id = copyOfout1.rawData_vehicle_id;
					oneRow_tHashOutput_3.rawData_vehicle_name = copyOfout1.rawData_vehicle_name;
					oneRow_tHashOutput_3.rawData_time = copyOfout1.rawData_time;
					oneRow_tHashOutput_3.rawData_maxAccelerationGForce = copyOfout1.rawData_maxAccelerationGForce;
					oneRow_tHashOutput_3.rawData_downloadForwardVideoUrl = copyOfout1.rawData_downloadForwardVideoUrl;
					oneRow_tHashOutput_3.rawData_downloadInwardVideoUrl = copyOfout1.rawData_downloadInwardVideoUrl;
					oneRow_tHashOutput_3.rawData_downloadTrackedInwardVideoUrl = copyOfout1.rawData_downloadTrackedInwardVideoUrl;
					oneRow_tHashOutput_3.rawData_location_latitude = copyOfout1.rawData_location_latitude;
					oneRow_tHashOutput_3.rawData_location_longitude = copyOfout1.rawData_location_longitude;
					oneRow_tHashOutput_3.rawData_coachingState = copyOfout1.rawData_coachingState;
					oneRow_tHashOutput_3.rawData_behaviorLabels_label = copyOfout1.rawData_behaviorLabels_label;
					oneRow_tHashOutput_3.rawData_behaviorLabels_source = copyOfout1.rawData_behaviorLabels_source;
					oneRow_tHashOutput_3.rawData_behaviorLabels_name = copyOfout1.rawData_behaviorLabels_name;
					oneRow_tHashOutput_3.latitude = copyOfout1.latitude;
					oneRow_tHashOutput_3.longitude = copyOfout1.longitude;
					oneRow_tHashOutput_3.gForceInfo_eventDateTime = copyOfout1.gForceInfo_eventDateTime;
					oneRow_tHashOutput_3.gForceInfo_gForce = copyOfout1.gForceInfo_gForce;
					oneRow_tHashOutput_3.rawData_driver = copyOfout1.rawData_driver;
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
    ...
    static byte[] commonByteArray_TEST_G_HDO_safety_events = new byte[0];
			    ...
			    public Double max_acceleration_gforce;

				public Double getMax_acceleration_gforce () {
					return this.max_acceleration_gforce;
				}
				
			    public String download_forward_video_url;

				public String getDownload_forward_video_url () {
					return this.download_forward_video_url;
				}
				
			    public String download_inward_video_url;

				public String getDownload_inward_video_url () {
					return this.download_inward_video_url;
				}
				
			    public String download_tracked_inward_video_url;

				public String getDownload_tracked_inward_video_url () {
					return this.download_tracked_inward_video_url;
				}
			    ...
			    public String coaching_state;

				public String getCoaching_state () {
					return this.coaching_state;
				}
				
			    public String behavior_label;

				public String getBehavior_label () {
					return this.behavior_label;
				}
				
			    public String behavior_label_source;

				public String getBehavior_label_source () {
					return this.behavior_label_source;
				}
				
			    public String behavior_label_name;

				public String getBehavior_label_name () {
					return this.behavior_label_name;
				}
		...
		synchronized(commonByteArrayLock_TEST_G_HDO_safety_events) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.start_time_event = readString(dis);
					...
					this.vehicle_name = readString(dis);
					
					this.time = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.max_acceleration_gforce = null;
           				} else {
           			    	this.max_acceleration_gforce = dis.readDouble();
           				}
					
					this.download_forward_video_url = readString(dis);
					
					this.download_inward_video_url = readString(dis);
					
					this.download_tracked_inward_video_url = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.location_latitude = null;
           				} else {
           			    	this.location_latitude = dis.readDouble();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.location_longitude = dis.readDouble();
           				}
					
					this.coaching_state = readString(dis);
					
					this.behavior_label = readString(dis);
					
					this.behavior_label_source = readString(dis);
					
					this.behavior_label_name = readString(dis);
					...
					this.event_datetime = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.gforce = null;
           				} else {
           			    	this.gforce = dis.readDouble();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.start_time_event,dos);
					...
					// String
						...
						writeString(this.vehicle_name,dos);
					...
					// Double
						...
						if(this.max_acceleration_gforce == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.max_acceleration_gforce);
		            	}
					
					// String
				
						writeString(this.download_forward_video_url,dos);
					
					// String
				
						writeString(this.download_inward_video_url,dos);
					
					// String
				
						writeString(this.download_tracked_inward_video_url,dos);
					...
					// Double
						...
						if(this.location_latitude == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.location_latitude);
		            	}
					...
					// Double
						...
						if(this.location_longitude == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.location_longitude);
		            	}
					
					// String
				
						writeString(this.coaching_state,dos);
					
					// String
				
						writeString(this.behavior_label,dos);
					
					// String
				
						writeString(this.behavior_label_source,dos);
					
					// String
				
						writeString(this.behavior_label_name,dos);
					...
					// String
						...
						writeString(this.event_datetime,dos);
    ...
    public String toString() {
		...
		sb.append(",start_time_event="+start_time_event);
		sb.append(",vehicle_id="+vehicle_id);
		sb.append(",rawdata_id="+rawdata_id);
		sb.append(",rawdata_driver_id="+rawdata_driver_id);
		sb.append(",rawdata_driver_name="+rawdata_driver_name);
		sb.append(",rawdata_vehicle_id="+rawdata_vehicle_id);
		sb.append(",vehicle_name="+vehicle_name);
		sb.append(",time="+time);
		sb.append(",max_acceleration_gforce="+String.valueOf(max_acceleration_gforce));
		sb.append(",download_forward_video_url="+download_forward_video_url);
		sb.append(",download_inward_video_url="+download_inward_video_url);
		sb.append(",download_tracked_inward_video_url="+download_tracked_inward_video_url);
		sb.append(",location_latitude="+String.valueOf(location_latitude));
		sb.append(",location_longitude="+String.valueOf(location_longitude));
		sb.append(",coaching_state="+coaching_state);
		sb.append(",behavior_label="+behavior_label);
		sb.append(",behavior_label_source="+behavior_label_source);
		sb.append(",behavior_label_name="+behavior_label_name);
		sb.append(",latitude="+String.valueOf(latitude));
		sb.append(",longitude="+String.valueOf(longitude));
		sb.append(",event_datetime="+event_datetime);
		sb.append(",gforce="+String.valueOf(gforce));
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    static byte[] commonByteArray_TEST_G_HDO_safety_events = new byte[0];
			    ...
			    public Double rawData_maxAccelerationGForce;

				public Double getRawData_maxAccelerationGForce () {
					return this.rawData_maxAccelerationGForce;
				}
			    ...
			    public Double rawData_location_latitude;

				public Double getRawData_location_latitude () {
					return this.rawData_location_latitude;
				}
				
			    public Double rawData_location_longitude;

				public Double getRawData_location_longitude () {
					return this.rawData_location_longitude;
				}
			    ...
			    public Double gForceInfo_gForce;

				public Double getGForceInfo_gForce () {
					return this.gForceInfo_gForce;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.rawData_time = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.rawData_maxAccelerationGForce = null;
           				} else {
           			    	this.rawData_maxAccelerationGForce = dis.readDouble();
           				}
					...
					this.rawData_downloadTrackedInwardVideoUrl = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.rawData_location_latitude = null;
           				} else {
           			    	this.rawData_location_latitude = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.rawData_location_longitude = null;
           				} else {
           			    	this.rawData_location_longitude = dis.readDouble();
           				}
					...
					this.gForceInfo_eventDateTime = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.gForceInfo_gForce = null;
           				} else {
           			    	this.gForceInfo_gForce = dis.readDouble();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Double
						...
						if(this.rawData_maxAccelerationGForce == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.rawData_maxAccelerationGForce);
		            	}
					...
					// Double
						...
						if(this.rawData_location_latitude == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.rawData_location_latitude);
		            	}
					
					// Double
				
						if(this.rawData_location_longitude == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.rawData_location_longitude);
		            	}
					...
					// Double
						...
						if(this.gForceInfo_gForce == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.gForceInfo_gForce);
		            	}
    ...
    public String toString() {
		...
		sb.append(",rawData_vehicle_name="+rawData_vehicle_name);
		sb.append(",rawData_time="+rawData_time);
		sb.append(",rawData_maxAccelerationGForce="+String.valueOf(rawData_maxAccelerationGForce));
		sb.append(",rawData_downloadForwardVideoUrl="+rawData_downloadForwardVideoUrl);
		sb.append(",rawData_downloadInwardVideoUrl="+rawData_downloadInwardVideoUrl);
		sb.append(",rawData_downloadTrackedInwardVideoUrl="+rawData_downloadTrackedInwardVideoUrl);
		sb.append(",rawData_location_latitude="+String.valueOf(rawData_location_latitude));
		sb.append(",rawData_location_longitude="+String.valueOf(rawData_location_longitude));
		sb.append(",rawData_coachingState="+rawData_coachingState);
		sb.append(",rawData_behaviorLabels_label="+rawData_behaviorLabels_label);
		sb.append(",rawData_behaviorLabels_source="+rawData_behaviorLabels_source);
		sb.append(",rawData_behaviorLabels_name="+rawData_behaviorLabels_name);
		...
		sb.append(",longitude="+String.valueOf(longitude));
		sb.append(",gForceInfo_eventDateTime="+gForceInfo_eventDateTime);
		sb.append(",gForceInfo_gForce="+String.valueOf(gForceInfo_gForce));
		sb.append(",rawData_driver="+rawData_driver);
	    sb.append("]");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<copyOfout1Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_G_HDO_safety_events_" + pid +"_tHashOutput_3");
...
while (iterator_tHashInput_3.hasNext()) {
	...
	row1.driverId = next_tHashInput_3.driverId;
	row1.driverName = next_tHashInput_3.driverName;
	row1.eventType = next_tHashInput_3.eventType;
	row1.startTimeEvent = next_tHashInput_3.startTimeEvent;
	row1.vehicleId = next_tHashInput_3.vehicleId;
	row1.rawData_id = next_tHashInput_3.rawData_id;
	row1.rawData_driver_id = next_tHashInput_3.rawData_driver_id;
	row1.rawData_driver_name = next_tHashInput_3.rawData_driver_name;
	row1.rawData_vehicle_id = next_tHashInput_3.rawData_vehicle_id;
	row1.rawData_vehicle_name = next_tHashInput_3.rawData_vehicle_name;
	row1.rawData_time = next_tHashInput_3.rawData_time;
	row1.rawData_maxAccelerationGForce = next_tHashInput_3.rawData_maxAccelerationGForce;
	row1.rawData_downloadForwardVideoUrl = next_tHashInput_3.rawData_downloadForwardVideoUrl;
	row1.rawData_downloadInwardVideoUrl = next_tHashInput_3.rawData_downloadInwardVideoUrl;
	row1.rawData_downloadTrackedInwardVideoUrl = next_tHashInput_3.rawData_downloadTrackedInwardVideoUrl;
	row1.rawData_location_latitude = next_tHashInput_3.rawData_location_latitude;
	row1.rawData_location_longitude = next_tHashInput_3.rawData_location_longitude;
	row1.rawData_coachingState = next_tHashInput_3.rawData_coachingState;
	row1.rawData_behaviorLabels_label = next_tHashInput_3.rawData_behaviorLabels_label;
	row1.rawData_behaviorLabels_source = next_tHashInput_3.rawData_behaviorLabels_source;
	row1.rawData_behaviorLabels_name = next_tHashInput_3.rawData_behaviorLabels_name;
	row1.latitude = next_tHashInput_3.latitude;
	row1.longitude = next_tHashInput_3.longitude;
	row1.gForceInfo_eventDateTime = next_tHashInput_3.gForceInfo_eventDateTime;
	row1.gForceInfo_gForce = next_tHashInput_3.gForceInfo_gForce;
	row1.rawData_driver = next_tHashInput_3.rawData_driver;
...
// # Output table : 'out1'
out1_tmp.driverId = row1.driverId ;
out1_tmp.driverName = row1.driverName ;
out1_tmp.eventType = row1.eventType ;
out1_tmp.startTimeEvent = row1.startTimeEvent ;
out1_tmp.vehicleId = row1.vehicleId ;
out1_tmp.rawData_id = row1.rawData_id ;
out1_tmp.rawData_driver_id = row1.rawData_driver_id ;
out1_tmp.rawData_driver_name = row1.rawData_driver_name ;
out1_tmp.rawData_vehicle_id = row1.rawData_vehicle_id ;
out1_tmp.rawData_vehicle_name = row1.rawData_vehicle_name ;
out1_tmp.rawData_time = row1.rawData_time==null?null : 
row1.rawData_time.replace("Z", "").replace("T", " ") ;
out1_tmp.rawData_maxAccelerationGForce = row1.rawData_maxAccelerationGForce ;
out1_tmp.rawData_downloadForwardVideoUrl = row1.rawData_downloadForwardVideoUrl ;
out1_tmp.rawData_downloadInwardVideoUrl = row1.rawData_downloadInwardVideoUrl ;
out1_tmp.rawData_downloadTrackedInwardVideoUrl = row1.rawData_downloadTrackedInwardVideoUrl ;
out1_tmp.rawData_location_latitude = row1.rawData_location_latitude ;
out1_tmp.rawData_location_longitude = row1.rawData_location_longitude ;
out1_tmp.rawData_coachingState = row1.rawData_coachingState ;
out1_tmp.rawData_behaviorLabels_label = row1.rawData_behaviorLabels_label ;
out1_tmp.rawData_behaviorLabels_source = row1.rawData_behaviorLabels_source ;
out1_tmp.rawData_behaviorLabels_name = row1.rawData_behaviorLabels_name ;
out1_tmp.latitude = row1.latitude ;
out1_tmp.longitude = row1.longitude ;
out1_tmp.gForceInfo_eventDateTime = row1.gForceInfo_eventDateTime ;
out1_tmp.gForceInfo_gForce = row1.gForceInfo_gForce ;
out1_tmp.rawData_driver = row1.rawData_driver ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          try {
              row2.driverId=TypeConvert.String2String(out1.driverId);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.driverName=TypeConvert.String2String(out1.driverName);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.eventType=TypeConvert.String2String(out1.eventType);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.startTimeEvent=TypeConvert.String2String(out1.startTimeEvent);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.vehicleId=TypeConvert.String2String(out1.vehicleId);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_id=TypeConvert.String2String(out1.rawData_id);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_driver_id=TypeConvert.String2String(out1.rawData_driver_id);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_driver_name=TypeConvert.String2String(out1.rawData_driver_name);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_vehicle_id=TypeConvert.String2String(out1.rawData_vehicle_id);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_vehicle_name=TypeConvert.String2String(out1.rawData_vehicle_name);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_time=TypeConvert.String2String(out1.rawData_time);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_maxAccelerationGForce=TypeConvert.String2Double(out1.rawData_maxAccelerationGForce);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_downloadForwardVideoUrl=TypeConvert.String2String(out1.rawData_downloadForwardVideoUrl);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_downloadInwardVideoUrl=TypeConvert.String2String(out1.rawData_downloadInwardVideoUrl);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_downloadTrackedInwardVideoUrl=TypeConvert.String2String(out1.rawData_downloadTrackedInwardVideoUrl);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_location_latitude=TypeConvert.String2Double(out1.rawData_location_latitude);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_location_longitude=TypeConvert.String2Double(out1.rawData_location_longitude);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_coachingState=TypeConvert.String2String(out1.rawData_coachingState);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_behaviorLabels_label=TypeConvert.String2String(out1.rawData_behaviorLabels_label);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_behaviorLabels_source=TypeConvert.String2String(out1.rawData_behaviorLabels_source);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_behaviorLabels_name=TypeConvert.String2String(out1.rawData_behaviorLabels_name);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.latitude=TypeConvert.String2Double(out1.latitude);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.longitude=TypeConvert.String2Double(out1.longitude);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.gForceInfo_eventDateTime=TypeConvert.String2String(out1.gForceInfo_eventDateTime);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.gForceInfo_gForce=TypeConvert.String2Double(out1.gForceInfo_gForce);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              row2.rawData_driver=TypeConvert.String2String(out1.rawData_driver);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }
...
// # Output table : 'out4'
out4_tmp._index = "eos_hdo_tc_prod_safety_events_index" ;
...
out2_tmp.driver_id = row2.driverId ;
out2_tmp.driver_name = row2.driverName ;
out2_tmp.event_type = row2.eventType ;
out2_tmp.start_time_event = row2.startTimeEvent==null?null : row2.startTimeEvent.replace("-","/") ;
out2_tmp.vehicle_id = row2.vehicleId ;
out2_tmp.rawdata_id = row2.rawData_id ;
out2_tmp.rawdata_driver_id = row2.rawData_driver_id ;
out2_tmp.rawdata_driver_name = row2.rawData_driver_name ;
out2_tmp.rawdata_vehicle_id = row2.rawData_vehicle_id ;
out2_tmp.vehicle_name = row2.rawData_vehicle_name ;
out2_tmp.time = row2.rawData_time==null?null : row2.rawData_time.replace("-","/") ;
out2_tmp.max_acceleration_gforce = row2.rawData_maxAccelerationGForce ;
out2_tmp.download_forward_video_url = row2.rawData_downloadForwardVideoUrl ;
out2_tmp.download_inward_video_url = row2.rawData_downloadInwardVideoUrl ;
out2_tmp.download_tracked_inward_video_url = row2.rawData_downloadTrackedInwardVideoUrl ;
out2_tmp.location_latitude = row2.rawData_location_latitude ;
out2_tmp.location_longitude = row2.rawData_location_longitude ;
out2_tmp.coaching_state = row2.rawData_coachingState ;
out2_tmp.behavior_label = row2.rawData_behaviorLabels_label ;
out2_tmp.behavior_label_source = row2.rawData_behaviorLabels_source ;
out2_tmp.behavior_label_name = row2.rawData_behaviorLabels_name ;
out2_tmp.latitude = row2.latitude ;
out2_tmp.longitude = row2.longitude ;
out2_tmp.event_datetime = row2.gForceInfo_eventDateTime==null?null : row2.gForceInfo_eventDateTime.replace("-","/") ;
out2_tmp.gforce = row2.gForceInfo_gForce ;
out2_tmp.driver = row2.rawData_driver ;
out2 = out2_tmp;
// ###############################
...
if(out2 != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("driver_name",
	(
		out2.driver_name != null?
            out2.driver_name.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("driver_name",
	(
		out2.driver_name != null?
            out2.driver_name.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("event_type",
	(
		out2.event_type != null?
            out2.event_type.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("event_type",
	(
		out2.event_type != null?
            out2.event_type.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("start_time_event",
	(
		out2.start_time_event != null?
            out2.start_time_event.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("start_time_event",
	(
		out2.start_time_event != null?
            out2.start_time_event.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("rawdata_id",
	(
		out2.rawdata_id != null?
            out2.rawdata_id.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("rawdata_id",
	(
		out2.rawdata_id != null?
            out2.rawdata_id.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("rawdata_driver_id",
	(
		out2.rawdata_driver_id != null?
            out2.rawdata_driver_id.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("rawdata_driver_id",
	(
		out2.rawdata_driver_id != null?
            out2.rawdata_driver_id.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("rawdata_driver_name",
	(
		out2.rawdata_driver_name != null?
            out2.rawdata_driver_name.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("rawdata_driver_name",
	(
		out2.rawdata_driver_name != null?
            out2.rawdata_driver_name.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("rawdata_vehicle_id",
	(
		out2.rawdata_vehicle_id != null?
            out2.rawdata_vehicle_id.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("rawdata_vehicle_id",
	(
		out2.rawdata_vehicle_id != null?
            out2.rawdata_vehicle_id.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("vehicle_name",
	(
		out2.vehicle_name != null?
            out2.vehicle_name.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("vehicle_name",
	(
		out2.vehicle_name != null?
            out2.vehicle_name.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("time",
	(
		out2.time != null?
            out2.time.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("time",
	(
		out2.time != null?
            out2.time.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("max_acceleration_gforce",
	(
		out2.max_acceleration_gforce != null?
            out2.max_acceleration_gforce.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("max_acceleration_gforce",
	(
		out2.max_acceleration_gforce != null?
            out2.max_acceleration_gforce.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("download_forward_video_url",
	(
		out2.download_forward_video_url != null?
            out2.download_forward_video_url.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("download_forward_video_url",
	(
		out2.download_forward_video_url != null?
            out2.download_forward_video_url.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("download_inward_video_url",
	(
		out2.download_inward_video_url != null?
            out2.download_inward_video_url.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("download_inward_video_url",
	(
		out2.download_inward_video_url != null?
            out2.download_inward_video_url.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("download_tracked_inward_video_url",
	(
		out2.download_tracked_inward_video_url != null?
            out2.download_tracked_inward_video_url.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("download_tracked_inward_video_url",
	(
		out2.download_tracked_inward_video_url != null?
            out2.download_tracked_inward_video_url.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("location_latitude",
	(
		out2.location_latitude != null?
            out2.location_latitude.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("location_latitude",
	(
		out2.location_latitude != null?
            out2.location_latitude.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("location_longitude",
	(
		out2.location_longitude != null?
            out2.location_longitude.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("location_longitude",
	(
		out2.location_longitude != null?
            out2.location_longitude.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("coaching_state",
	(
		out2.coaching_state != null?
            out2.coaching_state.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("coaching_state",
	(
		out2.coaching_state != null?
            out2.coaching_state.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("behavior_label",
	(
		out2.behavior_label != null?
            out2.behavior_label.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("behavior_label",
	(
		out2.behavior_label != null?
            out2.behavior_label.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("behavior_label_source",
	(
		out2.behavior_label_source != null?
            out2.behavior_label_source.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("behavior_label_source",
	(
		out2.behavior_label_source != null?
            out2.behavior_label_source.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("behavior_label_name",
	(
		out2.behavior_label_name != null?
            out2.behavior_label_name.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("behavior_label_name",
	(
		out2.behavior_label_name != null?
            out2.behavior_label_name.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("latitude",
	(
		out2.latitude != null?
            out2.latitude.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("latitude",
	(
		out2.latitude != null?
            out2.latitude.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("longitude",
	(
		out2.longitude != null?
            out2.longitude.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("longitude",
	(
		out2.longitude != null?
            out2.longitude.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("event_datetime",
	(
		out2.event_datetime != null?
            out2.event_datetime.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("event_datetime",
	(
		out2.event_datetime != null?
            out2.event_datetime.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("gforce",
	(
		out2.gforce != null?
            out2.gforce.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("gforce",
	(
		out2.gforce != null?
            out2.gforce.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("driver",
	(
		out2.driver != null?
            out2.driver.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("driver",
	(
		out2.driver != null?
            out2.driver.toString():null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_2_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("driver_id");
		if(
		...
		org.dom4j.Element root_3_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("driver_name");
		if(
		valueMap_tWriteJSONField_2_Out.get("driver_name")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_3_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("driver_name"));
		}
		org.dom4j.Element root_4_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("event_type");
		if(
		valueMap_tWriteJSONField_2_Out.get("event_type")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_4_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("event_type"));
		}
		org.dom4j.Element root_5_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("start_time_event");
		if(
		valueMap_tWriteJSONField_2_Out.get("start_time_event")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_5_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("start_time_event"));
		}
		org.dom4j.Element root_6_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("vehicle_id");
		if(
		...
		org.dom4j.Element root_7_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("rawdata_id");
		if(
		valueMap_tWriteJSONField_2_Out.get("rawdata_id")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_7_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("rawdata_id"));
		}
		org.dom4j.Element root_8_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("rawdata_driver_id");
		if(
		valueMap_tWriteJSONField_2_Out.get("rawdata_driver_id")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_8_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("rawdata_driver_id"));
		}
		org.dom4j.Element root_9_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("rawdata_driver_name");
		if(
		valueMap_tWriteJSONField_2_Out.get("rawdata_driver_name")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_9_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("rawdata_driver_name"));
		}
		org.dom4j.Element root_10_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("rawdata_vehicle_id");
		if(
		valueMap_tWriteJSONField_2_Out.get("rawdata_vehicle_id")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_10_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("rawdata_vehicle_id"));
		}
		org.dom4j.Element root_11_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("vehicle_name");
		if(
		valueMap_tWriteJSONField_2_Out.get("vehicle_name")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_11_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("vehicle_name"));
		}
		org.dom4j.Element root_12_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("time");
		if(
		valueMap_tWriteJSONField_2_Out.get("time")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_12_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("time"));
		}
		org.dom4j.Element root_13_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("max_acceleration_gforce");
		if(
		valueMap_tWriteJSONField_2_Out.get("max_acceleration_gforce")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_13_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("max_acceleration_gforce"));
            root_13_tWriteJSONField_2_Out.addAttribute("type", "number");
		}
		org.dom4j.Element root_14_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("download_forward_video_url");
		if(
		valueMap_tWriteJSONField_2_Out.get("download_forward_video_url")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_14_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("download_forward_video_url"));
		}
		org.dom4j.Element root_15_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("download_inward_video_url");
		if(
		valueMap_tWriteJSONField_2_Out.get("download_inward_video_url")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_15_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("download_inward_video_url"));
		}
		org.dom4j.Element root_16_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("download_tracked_inward_video_url");
		if(
		valueMap_tWriteJSONField_2_Out.get("download_tracked_inward_video_url")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_16_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("download_tracked_inward_video_url"));
		}
		org.dom4j.Element root_17_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("location_latitude");
		if(
		valueMap_tWriteJSONField_2_Out.get("location_latitude")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_17_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("location_latitude"));
            root_17_tWriteJSONField_2_Out.addAttribute("type", "number");
		}
		org.dom4j.Element root_18_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("location_longitude");
		if(
		valueMap_tWriteJSONField_2_Out.get("location_longitude")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_18_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("location_longitude"));
            root_18_tWriteJSONField_2_Out.addAttribute("type", "number");
		}
		org.dom4j.Element root_19_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("coaching_state");
		if(
		valueMap_tWriteJSONField_2_Out.get("coaching_state")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_19_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("coaching_state"));
		}
		org.dom4j.Element root_20_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("behavior_label");
		if(
		valueMap_tWriteJSONField_2_Out.get("behavior_label")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_20_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("behavior_label"));
		}
		org.dom4j.Element root_21_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("behavior_label_source");
		if(
		valueMap_tWriteJSONField_2_Out.get("behavior_label_source")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_21_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("behavior_label_source"));
		}
		org.dom4j.Element root_22_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("behavior_label_name");
		if(
		valueMap_tWriteJSONField_2_Out.get("behavior_label_name")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_22_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("behavior_label_name"));
		}
		org.dom4j.Element root_23_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("latitude");
		if(
		valueMap_tWriteJSONField_2_Out.get("latitude")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_23_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("latitude"));
            root_23_tWriteJSONField_2_Out.addAttribute("type", "number");
		}
		org.dom4j.Element root_24_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("longitude");
		if(
		valueMap_tWriteJSONField_2_Out.get("longitude")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_24_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("longitude"));
            root_24_tWriteJSONField_2_Out.addAttribute("type", "number");
		}
		org.dom4j.Element root_25_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("event_datetime");
		if(
		valueMap_tWriteJSONField_2_Out.get("event_datetime")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_25_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("event_datetime"));
		}
		org.dom4j.Element root_26_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("gforce");
		if(
		valueMap_tWriteJSONField_2_Out.get("gforce")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_26_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("gforce"));
            root_26_tWriteJSONField_2_Out.addAttribute("type", "number");
		}
		org.dom4j.Element root_27_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("driver");
		if(
		valueMap_tWriteJSONField_2_Out.get("driver")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_27_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("driver"));
		}
		org.dom4j.Element root_28_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("current_date");
		if(
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_G_HDO_safety_events_" + pid +"_tHashOutput_3");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_G_HDO_safety_events_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_G_HDO_safety_events_" + pid + "_tHashOutput_2";
 ...
 */
    ...
    public static void main(String[] args){
        final G_HDO_safety_events G_HDO_safety_eventsClass = new G_HDO_safety_events();

        int exitCode = G_HDO_safety_eventsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = G_HDO_safety_events.class.getClassLoader().getResourceAsStream("test/g_hdo_safety_events_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = G_HDO_safety_events.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : G_HDO_safety_events");
        }
...
/************************************************************************************************
 *     352771 characters generated by Talend Open Studio for Data Integration 
