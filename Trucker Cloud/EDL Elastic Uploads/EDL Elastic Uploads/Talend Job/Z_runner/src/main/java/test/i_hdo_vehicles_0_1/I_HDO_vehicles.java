...
package test.i_hdo_vehicles_0_1;
...
/**
 * Job: I_HDO_vehicles Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20190924_1038-M2
 * @status 
 */
public class I_HDO_vehicles implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "I_HDO_vehicles";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				I_HDO_vehicles.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(I_HDO_vehicles.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_TEST_I_HDO_vehicles = new byte[0];
    static byte[] commonByteArray_TEST_I_HDO_vehicles = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_I_HDO_vehicles.length) {
				if(length < 1024 && commonByteArray_TEST_I_HDO_vehicles.length == 0) {
   					commonByteArray_TEST_I_HDO_vehicles = new byte[1024];
				} else {
   					commonByteArray_TEST_I_HDO_vehicles = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_I_HDO_vehicles, 0, length);
			strReturn = new String(commonByteArray_TEST_I_HDO_vehicles, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_I_HDO_vehicles) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_vehicles/HDO_vehicles.json")).getAbsolutePath().replace("\\","/");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_I_HDO_vehicles_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_I_HDO_vehicles_" + pid +"_tHashOutput_1");
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_vehicles_prod_index" ,env_tSystem_1);
...
try{
    ...
    int bos_buffer_tHttpRequest_1 = 0;
            java.io.InputStream bisParam_tHttpRequest_1 = new java.io.BufferedInputStream(new java.io.FileInputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_vehiclesFRH.json"));
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_1) {
        java.io.InputStream bis_tHttpRequest_1 = new java.io.BufferedInputStream(urlConn_tHttpRequest_1.getInputStream());
                java.io.File bosParent_tHttpRequest_1 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_vehicle_error.json").getParentFile();
                if (bosParent_tHttpRequest_1 != null && bosParent_tHttpRequest_1.exists() == false){
                    bosParent_tHttpRequest_1.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_1 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_vehicle_error.json"));
...
public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_2 = "D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_vehicles";
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_2 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_2.add("HDO_vehicles*.json");  
...
try{
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_2) {
        java.io.InputStream bis_tHttpRequest_2 = new java.io.BufferedInputStream(urlConn_tHttpRequest_2.getInputStream());
                java.io.File bosParent_tHttpRequest_2 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_vehicles/Error/HDO_tc_veh_Error"+Numeric.sequence("z1",0,1)+".json").getParentFile();
                if (bosParent_tHttpRequest_2 != null && bosParent_tHttpRequest_2.exists() == false){
                    bosParent_tHttpRequest_2.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_2 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_vehicles/Error/HDO_tc_veh_Error"+Numeric.sequence("z1",0,1)+".json"));
...
final Process ps_tSystem_2 = runtime_tSystem_2.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_vehicles_prod_index/_doc/1?pretty" ,env_tSystem_2);
 ...
 */
	...
	currentComponent="tFileCopy_1";
        ...
        String srcFileName_tFileCopy_1 = "D:/HDO/EDL Elastic Uploads/Input/"+TalendDate.formatDate("yyyy-MM-dd",TalendDate.getCurrentDate())+".zip";
        ...
        String desDirName_tFileCopy_1 = "D:/HDO/EDL Elastic Uploads/Input/Archive";
		...
		if (!srcFile_tFileCopy_1.getPath().equals(desFile_tFileCopy_1.getPath())  ) {
				...
				java.io.File isRemoved_tFileCopy_1 = new java.io.File("D:/HDO/EDL Elastic Uploads/Input/"+TalendDate.formatDate("yyyy-MM-dd",TalendDate.getCurrentDate())+".zip");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_I_HDO_vehicles_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_I_HDO_vehicles_" + pid +"_tHashOutput_2");
...
public void tFileList_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_3 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_3.add("*vehicles*.xlsx");  
...
public static class copyOfoutchStruct implements routines.system.IPersistableRow<copyOfoutchStruct> {
    final static byte[] commonByteArrayLock_TEST_I_HDO_vehicles = new byte[0];
    static byte[] commonByteArray_TEST_I_HDO_vehicles = new byte[0];
			    ...
			    public String eldVendors_eldVendor;

				public String getEldVendors_eldVendor () {
					return this.eldVendors_eldVendor;
				}
			    ...
			    public String assetEldId;

				public String getAssetEldId () {
					return this.assetEldId;
				}
		...
		synchronized(commonByteArrayLock_TEST_I_HDO_vehicles) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.eldVendors_eldVendor = readString(dis);
					
					this.assetId = readString(dis);
					
					this.assetEldId = readString(dis);
					
					this.licensePlate = readString(dis);
					
					this.assetNumber = readString(dis);
					
					this.vehicleId = readString(dis);
					
					this.assetType = readString(dis);
					
					this.vehicleClass = readString(dis);
					
					this.bodyClass = readString(dis);
					
					this.make = readString(dis);
					
					this.model = readString(dis);
					
					this.modelYear = readString(dis);
					
					this.deviceId = readString(dis);
					
					this.createdTime = readString(dis);
					
					this.updatedTime = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.carrierId,dos);
					...
					// String
						...
						writeString(this.eldVendors_eldVendor,dos);
					...
					// String
						...
						writeString(this.assetEldId,dos);
					...
					// String
						...
						writeString(this.assetNumber,dos);
					...
					// String
						...
						writeString(this.assetType,dos);
					
					// String
				
						writeString(this.vehicleClass,dos);
					
					// String
				
						writeString(this.bodyClass,dos);
					...
					// String
						...
						writeString(this.modelYear,dos);
					
					// String
				
						writeString(this.deviceId,dos);
					
					// String
				
						writeString(this.createdTime,dos);
					
					// String
				
						writeString(this.updatedTime,dos);
    ...
    public String toString() {
		...
		sb.append(",eldVendors_eldVendor="+eldVendors_eldVendor);
		sb.append(",assetId="+assetId);
		sb.append(",assetEldId="+assetEldId);
		sb.append(",licensePlate="+licensePlate);
		sb.append(",assetNumber="+assetNumber);
		sb.append(",vehicleId="+vehicleId);
		sb.append(",assetType="+assetType);
		sb.append(",vehicleClass="+vehicleClass);
		sb.append(",bodyClass="+bodyClass);
		sb.append(",make="+make);
		sb.append(",model="+model);
		sb.append(",modelYear="+modelYear);
     ...
     * Compare keys
     */
    public int compareTo(copyOfoutchStruct other) {
...
copyOfoutchStruct copyOfoutch = new copyOfoutchStruct();
	...
	currentComponent="tHashOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfoutch");
					}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<copyOfoutchStruct> tHashFile_tHashOutput_3 = null;
		String hashKey_tHashOutput_3 = "tHashFile_I_HDO_vehicles_" + pid + "_tHashOutput_3";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_3)){
			    if(mf_tHashOutput_3.getResourceMap().get(hashKey_tHashOutput_3) == null){
	      		    mf_tHashOutput_3.getResourceMap().put(hashKey_tHashOutput_3, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<copyOfoutchStruct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
...
// ###############################
// # Outputs initialization
copyOfoutchStruct copyOfoutch_tmp = new copyOfoutchStruct();
// ###############################
 ...
 */
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
		    ...
		    row2 = null;
					int tempRowLength_tFileInputExcel_2 = 21;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				curColName_tFileInputExcel_2 = "carrierId";

				row2.carrierId = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.carrierId = null;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row2.carrierName = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.carrierName = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row2.type = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.type = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row2.carrierCodes_codeType = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.carrierCodes_codeType = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row2.carrierCodes_carrierCode = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.carrierCodes_carrierCode = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "eldVendors_eldVendor";

				row2.eldVendors_eldVendor = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.eldVendors_eldVendor = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "assetEldId";

				row2.assetEldId = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.assetEldId = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row2.licensePlate = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.licensePlate = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "assetNumber";

				row2.assetNumber = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.assetNumber = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row2.vehicleId = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.vehicleId = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "assetType";

				row2.assetType = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.assetType = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "vehicleClass";

				row2.vehicleClass = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.vehicleClass = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "bodyClass";

				row2.bodyClass = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.bodyClass = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "make";

				row2.make = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.make = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "model";

				row2.model = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.model = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "modelYear";

				row2.modelYear = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.modelYear = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "createdTime";

				row2.createdTime = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "updatedTime";

				row2.updatedTime = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.updatedTime = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "vin";

				row2.vin = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.vin = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "deviceId";

				row2.deviceId = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.deviceId = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
...
// # Output table : 'copyOfoutch'
copyOfoutch_tmp.carrierId = row2.carrierId ;
copyOfoutch_tmp.carrierName = row2.carrierName ;
copyOfoutch_tmp.type = row2.type ;
copyOfoutch_tmp.carrierCodes_codeType = row2.carrierCodes_codeType ;
copyOfoutch_tmp.carrierCodes_carrierCode = row2.carrierCodes_carrierCode ;
copyOfoutch_tmp.eldVendors_eldVendor = row2.eldVendors_eldVendor ;
copyOfoutch_tmp.assetId = row2.assetId ;
copyOfoutch_tmp.assetEldId = row2.assetEldId ;
copyOfoutch_tmp.licensePlate = row2.licensePlate ;
copyOfoutch_tmp.assetNumber = row2.assetNumber ;
copyOfoutch_tmp.vehicleId = row2.vehicleId ;
copyOfoutch_tmp.assetType = row2.assetType ;
copyOfoutch_tmp.vehicleClass = row2.vehicleClass ;
copyOfoutch_tmp.bodyClass = row2.bodyClass ;
copyOfoutch_tmp.make = row2.make ;
copyOfoutch_tmp.model = row2.model ;
copyOfoutch_tmp.modelYear = row2.modelYear ;
copyOfoutch_tmp.deviceId = row2.deviceId ;
copyOfoutch_tmp.createdTime = row2.createdTime==null?null : row2.createdTime.replace(".0", "").replace("-", "/").trim() ;
copyOfoutch_tmp.updatedTime = row2.updatedTime==null?null : row2.updatedTime.replace(".0", "").replace("-", "/").trim() ;
copyOfoutch_tmp.vin = row2.vin ;
copyOfoutch = copyOfoutch_tmp;
// ###############################
...
if(copyOfoutch != null) { 
	...
	currentComponent="tHashOutput_3";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"copyOfoutch");
					}
		...
		copyOfoutchStruct oneRow_tHashOutput_3 = new copyOfoutchStruct();
				
					oneRow_tHashOutput_3.carrierId = copyOfoutch.carrierId;
					oneRow_tHashOutput_3.carrierName = copyOfoutch.carrierName;
					oneRow_tHashOutput_3.type = copyOfoutch.type;
					oneRow_tHashOutput_3.carrierCodes_codeType = copyOfoutch.carrierCodes_codeType;
					oneRow_tHashOutput_3.carrierCodes_carrierCode = copyOfoutch.carrierCodes_carrierCode;
					oneRow_tHashOutput_3.eldVendors_eldVendor = copyOfoutch.eldVendors_eldVendor;
					oneRow_tHashOutput_3.assetId = copyOfoutch.assetId;
					oneRow_tHashOutput_3.assetEldId = copyOfoutch.assetEldId;
					oneRow_tHashOutput_3.licensePlate = copyOfoutch.licensePlate;
					oneRow_tHashOutput_3.assetNumber = copyOfoutch.assetNumber;
					oneRow_tHashOutput_3.vehicleId = copyOfoutch.vehicleId;
					oneRow_tHashOutput_3.assetType = copyOfoutch.assetType;
					oneRow_tHashOutput_3.vehicleClass = copyOfoutch.vehicleClass;
					oneRow_tHashOutput_3.bodyClass = copyOfoutch.bodyClass;
					oneRow_tHashOutput_3.make = copyOfoutch.make;
					oneRow_tHashOutput_3.model = copyOfoutch.model;
					oneRow_tHashOutput_3.modelYear = copyOfoutch.modelYear;
					oneRow_tHashOutput_3.deviceId = copyOfoutch.deviceId;
					oneRow_tHashOutput_3.createdTime = copyOfoutch.createdTime;
					oneRow_tHashOutput_3.updatedTime = copyOfoutch.updatedTime;
					oneRow_tHashOutput_3.vin = copyOfoutch.vin;
...
globalMap.put("tHashOutput_3_NB_LINE", nb_line_tHashOutput_3);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfoutch");
			  	}
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
    ...
    static byte[] commonByteArray_TEST_I_HDO_vehicles = new byte[0];
			    ...
			    public String eld_vendor;

				public String getEld_vendor () {
					return this.eld_vendor;
				}
		...
		synchronized(commonByteArrayLock_TEST_I_HDO_vehicles) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.eld_vendor = readString(dis);
					
					this.asset_id = readString(dis);
					
					this.asset_eld_id = readString(dis);
					
					this.license_plate = readString(dis);
					
					this.asset_number = readString(dis);
					
					this.vehicle_id = readString(dis);
					
					this.asset_type = readString(dis);
					
					this.vehicle_class = readString(dis);
					
					this.body_class = readString(dis);
					...
					this.created_time = readString(dis);
					
					this.updated_time = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.eld_vendor,dos);
					...
					// String
						...
						writeString(this.license_plate,dos);
					
					// String
				
						writeString(this.asset_number,dos);
					...
					// String
						...
						writeString(this.asset_type,dos);
					
					// String
				
						writeString(this.vehicle_class,dos);
					
					// String
				
						writeString(this.body_class,dos);
					...
					// String
						...
						writeString(this.created_time,dos);
					
					// String
				
						writeString(this.updated_time,dos);
    ...
    public String toString() {
		...
		sb.append(",eld_vendor="+eld_vendor);
		sb.append(",asset_id="+asset_id);
		sb.append(",asset_eld_id="+asset_eld_id);
		sb.append(",license_plate="+license_plate);
		sb.append(",asset_number="+asset_number);
		sb.append(",vehicle_id="+vehicle_id);
		sb.append(",asset_type="+asset_type);
		sb.append(",vehicle_class="+vehicle_class);
		sb.append(",body_class="+body_class);
		sb.append(",make="+make);
		sb.append(",model="+model);
		sb.append(",year="+year);
...
public static class outchStruct implements routines.system.IPersistableRow<outchStruct> {
    final static byte[] commonByteArrayLock_TEST_I_HDO_vehicles = new byte[0];
    static byte[] commonByteArray_TEST_I_HDO_vehicles = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(outchStruct other) {
...
outchStruct outch = new outchStruct();
 ...
 */
	...
	currentComponent="tConvertType_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"outch");
					}
...
// ###############################
// # Outputs initialization
outchStruct outch_tmp = new outchStruct();
// ###############################
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<copyOfoutchStruct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_I_HDO_vehicles_" + pid +"_tHashOutput_3");
if(tHashFile_tHashInput_3==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<copyOfoutchStruct> iterator_tHashInput_3 = tHashFile_tHashInput_3.iterator();
while (iterator_tHashInput_3.hasNext()) {
    copyOfoutchStruct next_tHashInput_3 = iterator_tHashInput_3.next();

	row1.carrierId = next_tHashInput_3.carrierId;
	row1.carrierName = next_tHashInput_3.carrierName;
	row1.type = next_tHashInput_3.type;
	...
	row1.eldVendors_eldVendor = next_tHashInput_3.eldVendors_eldVendor;
	row1.assetId = next_tHashInput_3.assetId;
	row1.assetEldId = next_tHashInput_3.assetEldId;
	row1.licensePlate = next_tHashInput_3.licensePlate;
	row1.assetNumber = next_tHashInput_3.assetNumber;
	row1.vehicleId = next_tHashInput_3.vehicleId;
	row1.assetType = next_tHashInput_3.assetType;
	row1.vehicleClass = next_tHashInput_3.vehicleClass;
	row1.bodyClass = next_tHashInput_3.bodyClass;
	row1.make = next_tHashInput_3.make;
	row1.model = next_tHashInput_3.model;
	row1.modelYear = next_tHashInput_3.modelYear;
	row1.deviceId = next_tHashInput_3.deviceId;
	row1.createdTime = next_tHashInput_3.createdTime;
	row1.updatedTime = next_tHashInput_3.updatedTime;
	row1.vin = next_tHashInput_3.vin;
...
// # Output table : 'outch'
outch_tmp.carrierId = row1.carrierId ;
outch_tmp.carrierName = row1.carrierName ;
outch_tmp.type = row1.type ;
outch_tmp.carrierCodes_codeType = row1.carrierCodes_codeType ;
outch_tmp.carrierCodes_carrierCode = row1.carrierCodes_carrierCode ;
outch_tmp.eldVendors_eldVendor = row1.eldVendors_eldVendor ;
outch_tmp.assetId = row1.assetId ;
outch_tmp.assetEldId = row1.assetEldId ;
outch_tmp.licensePlate = row1.licensePlate ;
outch_tmp.assetNumber = row1.assetNumber ;
outch_tmp.vehicleId = row1.vehicleId ;
outch_tmp.assetType = row1.assetType ;
outch_tmp.vehicleClass = row1.vehicleClass ;
outch_tmp.bodyClass = row1.bodyClass ;
outch_tmp.make = row1.make ;
outch_tmp.model = row1.model ;
outch_tmp.modelYear = row1.modelYear ;
outch_tmp.deviceId = row1.deviceId ;
outch_tmp.createdTime = row1.createdTime==null?null : row1.createdTime.replace(".0", "").replace("-", "/").trim() ;
outch_tmp.updatedTime = row1.updatedTime==null?null : row1.updatedTime.replace(".0", "").replace("-", "/").trim() ;
outch_tmp.vin = row1.vin ;
outch = outch_tmp;
// ###############################
...
if(outch != null) { 
	...
	currentComponent="tConvertType_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"outch");
					}
  ...
  boolean bHasError_tConvertType_1 = false;             
          try {
              out1.carrierId=TypeConvert.String2String(outch.carrierId);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.carrierName=TypeConvert.String2String(outch.carrierName);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.type=TypeConvert.String2String(outch.type);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.carrierCodes_codeType=TypeConvert.String2String(outch.carrierCodes_codeType);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.carrierCodes_carrierCode=TypeConvert.String2String(outch.carrierCodes_carrierCode);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.eldVendors_eldVendor=TypeConvert.String2String(outch.eldVendors_eldVendor);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.assetId=TypeConvert.String2String(outch.assetId);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.assetEldId=TypeConvert.String2String(outch.assetEldId);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.licensePlate=TypeConvert.String2String(outch.licensePlate);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.assetNumber=TypeConvert.String2String(outch.assetNumber);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.vehicleId=TypeConvert.String2String(outch.vehicleId);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.assetType=TypeConvert.String2String(outch.assetType);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.vehicleClass=TypeConvert.String2String(outch.vehicleClass);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.bodyClass=TypeConvert.String2String(outch.bodyClass);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.make=TypeConvert.String2String(outch.make);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.model=TypeConvert.String2String(outch.model);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.modelYear=TypeConvert.String2String(outch.modelYear);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.deviceId=TypeConvert.String2String(outch.deviceId);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.createdTime=TypeConvert.String2String(outch.createdTime);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.updatedTime=TypeConvert.String2String(outch.updatedTime);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              out1.vin=TypeConvert.String2String(outch.vin);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }
...
// # Output table : 'out4'
out4_tmp._index = "eos_hdo_tc_vehicles_prod_index" ;
...
out2_tmp.carrier_id = out1.carrierId ;
...
out2_tmp.eld_vendor = out1.eldVendors_eldVendor ;
out2_tmp.asset_id = out1.assetId ;
out2_tmp.asset_eld_id = out1.assetEldId ;
out2_tmp.license_plate = out1.licensePlate ;
out2_tmp.asset_number = out1.assetNumber ;
out2_tmp.vehicle_id = out1.vehicleId ;
out2_tmp.asset_type = out1.assetType ;
out2_tmp.vehicle_class = out1.vehicleClass ;
out2_tmp.body_class = out1.bodyClass ;
out2_tmp.make = out1.make ;
out2_tmp.model = out1.model ;
out2_tmp.year = out1.modelYear ;
out2_tmp.device_id = out1.deviceId ;
out2_tmp.created_time = out1.createdTime ;
out2_tmp.updated_time = out1.updatedTime ;
out2_tmp.vin = out1.vin ;
out2 = out2_tmp;
// ###############################
...
if(out2 != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("carrier_id",
	(
		out2.carrier_id != null?
            out2.carrier_id.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("carrier_id",
	(
		out2.carrier_id != null?
            out2.carrier_id.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("type",
	(
		out2.type != null?
            out2.type.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("type",
	(
		out2.type != null?
            out2.type.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("eld_vendor",
	(
		out2.eld_vendor != null?
            out2.eld_vendor.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("eld_vendor",
	(
		out2.eld_vendor != null?
            out2.eld_vendor.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("license_plate",
	(
		out2.license_plate != null?
            out2.license_plate.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("license_plate",
	(
		out2.license_plate != null?
            out2.license_plate.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("asset_number",
	(
		out2.asset_number != null?
            out2.asset_number.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("asset_number",
	(
		out2.asset_number != null?
            out2.asset_number.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("asset_type",
	(
		out2.asset_type != null?
            out2.asset_type.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("asset_type",
	(
		out2.asset_type != null?
            out2.asset_type.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("vehicle_class",
	(
		out2.vehicle_class != null?
            out2.vehicle_class.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("vehicle_class",
	(
		out2.vehicle_class != null?
            out2.vehicle_class.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("body_class",
	(
		out2.body_class != null?
            out2.body_class.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("body_class",
	(
		out2.body_class != null?
            out2.body_class.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("make",
	(
		out2.make != null?
            out2.make.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("make",
	(
		out2.make != null?
            out2.make.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("model",
	(
		out2.model != null?
            out2.model.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("model",
	(
		out2.model != null?
            out2.model.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("year",
	(
		out2.year != null?
            out2.year.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("year",
	(
		out2.year != null?
            out2.year.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("created_time",
	(
		out2.created_time != null?
            out2.created_time.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("created_time",
	(
		out2.created_time != null?
            out2.created_time.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("updated_time",
	(
		out2.updated_time != null?
            out2.updated_time.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("updated_time",
	(
		out2.updated_time != null?
            out2.updated_time.toString():null
		));
	valueMap_tWriteJSONField_2_Out.put("vin",
	(
		out2.vin != null?
            out2.vin.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("vin",
	(
		out2.vin != null?
            out2.vin.toString():null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_2_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("carrier_id");
		if(
		valueMap_tWriteJSONField_2_Out.get("carrier_id")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_2_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("carrier_id"));
		}
		org.dom4j.Element root_3_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("carrier_name");
		if(
		...
		org.dom4j.Element root_4_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("type");
		if(
		valueMap_tWriteJSONField_2_Out.get("type")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_4_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("type"));
		}
		org.dom4j.Element root_5_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("code_type");
		if(
		...
		org.dom4j.Element root_6_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("carrier_code");
		if(
		...
		org.dom4j.Element root_7_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("eld_vendor");
		if(
		valueMap_tWriteJSONField_2_Out.get("eld_vendor")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_7_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("eld_vendor"));
		}
		org.dom4j.Element root_8_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("asset_id");
		if(
		...
		org.dom4j.Element root_9_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("asset_eld_id");
		if(
		...
		org.dom4j.Element root_10_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("license_plate");
		if(
		valueMap_tWriteJSONField_2_Out.get("license_plate")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_10_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("license_plate"));
		}
		org.dom4j.Element root_11_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("asset_number");
		if(
		valueMap_tWriteJSONField_2_Out.get("asset_number")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_11_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("asset_number"));
		}
		org.dom4j.Element root_12_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("vehicle_id");
		if(
		...
		org.dom4j.Element root_13_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("asset_type");
		if(
		valueMap_tWriteJSONField_2_Out.get("asset_type")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_13_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("asset_type"));
		}
		org.dom4j.Element root_14_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("vehicle_class");
		if(
		valueMap_tWriteJSONField_2_Out.get("vehicle_class")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_14_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("vehicle_class"));
		}
		org.dom4j.Element root_15_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("body_class");
		if(
		valueMap_tWriteJSONField_2_Out.get("body_class")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_15_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("body_class"));
		}
		org.dom4j.Element root_16_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("make");
		if(
		valueMap_tWriteJSONField_2_Out.get("make")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_16_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("make"));
		}
		org.dom4j.Element root_17_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("model");
		if(
		valueMap_tWriteJSONField_2_Out.get("model")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_17_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("model"));
		}
		org.dom4j.Element root_18_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("year");
		if(
		valueMap_tWriteJSONField_2_Out.get("year")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_18_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("year"));
		}
		org.dom4j.Element root_19_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("device_id");
		if(
		...
		org.dom4j.Element root_20_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("created_time");
		if(
		valueMap_tWriteJSONField_2_Out.get("created_time")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_20_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("created_time"));
		}
		org.dom4j.Element root_21_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("updated_time");
		if(
		valueMap_tWriteJSONField_2_Out.get("updated_time")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_21_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("updated_time"));
		}
		org.dom4j.Element root_22_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("vin");
		if(
		valueMap_tWriteJSONField_2_Out.get("vin")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_22_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("vin"));
		}
		org.dom4j.Element root_23_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("current_date");
		if(
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_I_HDO_vehicles_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tConvertType_1";
      ...
      globalMap.put("tConvertType_1_NB_LINE", nb_line_tConvertType_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"outch");
			  	}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_I_HDO_vehicles_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_I_HDO_vehicles_" + pid + "_tHashOutput_2";
 ...
 */
    ...
    public static void main(String[] args){
        final I_HDO_vehicles I_HDO_vehiclesClass = new I_HDO_vehicles();

        int exitCode = I_HDO_vehiclesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = I_HDO_vehicles.class.getClassLoader().getResourceAsStream("test/i_hdo_vehicles_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = I_HDO_vehicles.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : I_HDO_vehicles");
        }
...
/************************************************************************************************
 *     323175 characters generated by Talend Open Studio for Data Integration 
 *     on the August 8, 2024 1:11:09 PM IST
 ************************************************************************************************/