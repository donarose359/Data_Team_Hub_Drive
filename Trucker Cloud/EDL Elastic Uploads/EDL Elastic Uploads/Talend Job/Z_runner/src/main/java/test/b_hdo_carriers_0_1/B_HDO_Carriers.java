...
package test.b_hdo_carriers_0_1;
...
/**
 * Job: B_HDO_Carriers Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20190924_1038-M2
 * @status 
 */
public class B_HDO_Carriers implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "B_HDO_Carriers";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				B_HDO_Carriers.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(B_HDO_Carriers.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_TEST_B_HDO_Carriers = new byte[0];
    static byte[] commonByteArray_TEST_B_HDO_Carriers = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_B_HDO_Carriers.length) {
				if(length < 1024 && commonByteArray_TEST_B_HDO_Carriers.length == 0) {
   					commonByteArray_TEST_B_HDO_Carriers = new byte[1024];
				} else {
   					commonByteArray_TEST_B_HDO_Carriers = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_B_HDO_Carriers, 0, length);
			strReturn = new String(commonByteArray_TEST_B_HDO_Carriers, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_B_HDO_Carriers) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_carriers/HDO_carriers.json")).getAbsolutePath().replace("\\","/");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_B_HDO_Carriers_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_B_HDO_Carriers_" + pid +"_tHashOutput_1");
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_carrier_index" ,env_tSystem_1);
...
try{
    ...
    int bos_buffer_tHttpRequest_1 = 0;
            java.io.InputStream bisParam_tHttpRequest_1 = new java.io.BufferedInputStream(new java.io.FileInputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_carriersFRH.json"));
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_1) {
        java.io.InputStream bis_tHttpRequest_1 = new java.io.BufferedInputStream(urlConn_tHttpRequest_1.getInputStream());
                java.io.File bosParent_tHttpRequest_1 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_carrier_first_row_error.json").getParentFile();
                if (bosParent_tHttpRequest_1 != null && bosParent_tHttpRequest_1.exists() == false){
                    bosParent_tHttpRequest_1.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_1 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/First Row Headers/HDO_carrier_first_row_error.json"));
...
public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_2 = "D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_carriers";
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_2 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_2.add("HDO_carriers*.json");  
...
try{
    ...
    if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_2) {
        java.io.InputStream bis_tHttpRequest_2 = new java.io.BufferedInputStream(urlConn_tHttpRequest_2.getInputStream());
                java.io.File bosParent_tHttpRequest_2 = new java.io.File("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_carriers/Error/HDO_tc_carriers_Error"+Numeric.sequence("z1",0,1)+".json").getParentFile();
                if (bosParent_tHttpRequest_2 != null && bosParent_tHttpRequest_2.exists() == false){
                    bosParent_tHttpRequest_2.mkdirs();
                }
            java.io.OutputStream bosContent_tHttpRequest_2 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("D:/HDO/EDL Elastic Uploads/JSONs/Data/TC_carriers/Error/HDO_tc_carriers_Error"+Numeric.sequence("z1",0,1)+".json"));
...
final Process ps_tSystem_2 = runtime_tSystem_2.exec( "curl -XDELETE -u elastic:Acce$$ElastiC7747/ https://search-elk-soqgola6bhb67co64hiqigfsjq.us-east-1.es.amazonaws.com/eos_hdo_tc_prod_carrier_index/_doc/1?pretty" ,env_tSystem_2);
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_B_HDO_Carriers_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_B_HDO_Carriers_" + pid +"_tHashOutput_2");
...
public void tFileList_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_3 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_3.add("*carriers*.xlsx");  
...
public static class out3Struct implements routines.system.IPersistableRow<out3Struct> {
    ...
    static byte[] commonByteArray_TEST_B_HDO_Carriers = new byte[0];
			    ...
			    public String carrierInfoCodes;

				public String getCarrierInfoCodes () {
					return this.carrierInfoCodes;
				}
		...
		synchronized(commonByteArrayLock_TEST_B_HDO_Carriers) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.apiKey = readString(dis);
					
					this.status = readString(dis);
					
					this.type = readString(dis);
					
					this.carrierInfoCodes = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.carrierInfoCodes,dos);
    ...
    public String toString() {
		...
		sb.append(",type="+type);
		sb.append(",carrierInfoCodes="+carrierInfoCodes);
	    sb.append("]");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_B_HDO_Carriers_" + pid + "_tHashOutput_3";
 ...
 */
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "apiKey";

				row2.apiKey = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.apiKey = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "carrierInfoCodes";

				row2.carrierInfoCodes = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.carrierInfoCodes = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
...
// # Output table : 'out3'
out3_tmp.carrierId = row2.carrierId ;
...
out3_tmp.apiKey = row2.apiKey ;
out3_tmp.status = row2.status ;
out3_tmp.type = row2.type ;
out3_tmp.carrierInfoCodes = row2.carrierInfoCodes ;
out3 = out3_tmp;
// ###############################
...
if(out3 != null) { 
	...
	currentComponent="tHashOutput_3";
		...
		out3Struct oneRow_tHashOutput_3 = new out3Struct();
					...
					oneRow_tHashOutput_3.carrierId = out3.carrierId;
					...
					oneRow_tHashOutput_3.email = out3.email;
					oneRow_tHashOutput_3.eldVendor = out3.eldVendor;
					oneRow_tHashOutput_3.apiKey = out3.apiKey;
					oneRow_tHashOutput_3.status = out3.status;
					oneRow_tHashOutput_3.type = out3.type;
					oneRow_tHashOutput_3.carrierInfoCodes = out3.carrierInfoCodes;
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
    ...
    static byte[] commonByteArray_TEST_B_HDO_Carriers = new byte[0];
			    ...
			    public String carrier_info_codes;

				public String getCarrier_info_codes () {
					return this.carrier_info_codes;
				}
		...
		synchronized(commonByteArrayLock_TEST_B_HDO_Carriers) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.api_key = readString(dis);
					
					this.status = readString(dis);
					
					this.type = readString(dis);
					
					this.carrier_info_codes = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.carrier_info_codes,dos);
    ...
    public String toString() {
		...
		sb.append(",status="+status);
		sb.append(",type="+type);
		sb.append(",carrier_info_codes="+carrier_info_codes);
	    sb.append("]");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out3Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_B_HDO_Carriers_" + pid +"_tHashOutput_3");
...
while (iterator_tHashInput_3.hasNext()) {
	...
	row1.email = next_tHashInput_3.email;
	row1.eldVendor = next_tHashInput_3.eldVendor;
	row1.apiKey = next_tHashInput_3.apiKey;
	row1.status = next_tHashInput_3.status;
	row1.type = next_tHashInput_3.type;
	row1.carrierInfoCodes = next_tHashInput_3.carrierInfoCodes;
...
// # Output table : 'out1'
out1_tmp.carrierId = row1.carrierId ;
...
out1_tmp.apiKey = row1.apiKey ;
out1_tmp.status = row1.status ;
out1_tmp.type = row1.type ;
out1_tmp.carrierInfoCodes = row1.carrierInfoCodes ;
out1 = out1_tmp;
// ###############################
...
// # Output table : 'out4'
out4_tmp._index = "eos_hdo_tc_prod_carrier_index" ;
...
out2_tmp.email = out1.email ;
out2_tmp.eld_vendor = out1.eldVendor ;
out2_tmp.api_key = out1.apiKey ;
out2_tmp.status = out1.status ;
out2_tmp.type = out1.type ;
out2_tmp.carrier_info_codes = out1.carrierInfoCodes ;
out2 = out2_tmp;
// ###############################
...
if(out2 != null) { 
	...
	valueMap_tWriteJSONField_2_Out.put("email",
	(
		out2.email != null?
            out2.email.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("email",
	(
		out2.email != null?
            out2.email.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("api_key",
	(
		out2.api_key != null?
            out2.api_key.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("api_key",
	(
		out2.api_key != null?
            out2.api_key.toString():null
		));
	...
	valueMap_tWriteJSONField_2_Out.put("carrier_info_codes",
	(
		out2.carrier_info_codes != null?
            out2.carrier_info_codes.toString():null
		));
	arraysValueMap_tWriteJSONField_2_Out.put("carrier_info_codes",
	(
		out2.carrier_info_codes != null?
            out2.carrier_info_codes.toString():null
		));
	...
	if (needRoot_tWriteJSONField_2_Out) {
		...
		org.dom4j.Element root_4_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("first_name");
		if(
		...
		org.dom4j.Element root_5_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("last_name");
		if(
		...
		org.dom4j.Element root_7_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("code_type");
		if(
		...
		org.dom4j.Element root_8_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("email");
		if(
		valueMap_tWriteJSONField_2_Out.get("email")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_8_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("email"));
		}
		org.dom4j.Element root_9_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("eld_vendor");
		if(
		...
		org.dom4j.Element root_10_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("api_key");
		if(
		valueMap_tWriteJSONField_2_Out.get("api_key")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_10_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("api_key"));
		}
		org.dom4j.Element root_11_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("status");
		if(
		...
		org.dom4j.Element root_12_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("type");
		if(
		...
		org.dom4j.Element root_13_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("carrier_info_codes");
		if(
		valueMap_tWriteJSONField_2_Out.get("carrier_info_codes")!=null){
			nestXMLTool_tWriteJSONField_2_Out .setText(root_13_tWriteJSONField_2_Out,
		valueMap_tWriteJSONField_2_Out.get("carrier_info_codes"));
		}
		org.dom4j.Element root_14_tWriteJSONField_2_Out = root_tWriteJSONField_2_Out.addElement("current_date");
		if(
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_B_HDO_Carriers_" + pid +"_tHashOutput_3");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_B_HDO_Carriers_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_B_HDO_Carriers_" + pid + "_tHashOutput_2";
 ...
 */
    ...
    public static void main(String[] args){
        final B_HDO_Carriers B_HDO_CarriersClass = new B_HDO_Carriers();

        int exitCode = B_HDO_CarriersClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = B_HDO_Carriers.class.getClassLoader().getResourceAsStream("test/b_hdo_carriers_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = B_HDO_Carriers.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : B_HDO_Carriers");
        }
...
/************************************************************************************************
 *     274450 characters generated by Talend Open Studio for Data Integration 
 *     on the August 8, 2024 1:11:05 PM IST
 ************************************************************************************************/